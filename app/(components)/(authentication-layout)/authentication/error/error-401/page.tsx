                        ...
                        <div className="my-auto">
                            <div className="grid grid-cols-12 gap-x-6 h-full">
                                ...
                                <div className="xxl:col-span-4 xl:col-span-6 lg:col-span-8 md:col-span-10 col-span-10">
                                    <p className="error-text mb-4 text-white">401</p>
                                    ...
                                    <Link href="/dashboards/sales" className="ti-btn ti-btn-secondary">
                                        <i className="ri-arrow-left-line align-middle me-1 inline-block"></i>BACK TO HOME
                                    </Link>
                                </div>
                                ...
                                <div className="xxl:col-span-2 xl:col-span-1 lg:col-span-2 md:col-span-1 col-span-12"></div>
                            </div>
                        </div>
                    </div>
                </div>
