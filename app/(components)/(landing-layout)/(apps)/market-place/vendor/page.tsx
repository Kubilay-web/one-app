...
import { Accountdata, AllProducts, Companydata, Compatibledata, Downloads, Featuredata, Featureddata, Filesdata, Industrydata, Itemdata, Tagsdata } from "@/shared/data/apps/market-place/vendordata";
...
const Vendor = () => {
    ...
    return (
        <Fragment>
            {/* <!-- Start:: Breadcrumb--> */}
            <div className="!border-b border-defaultborder dark:border-defaultborder/10 md:py-4">
                <div className="container">
                    <Seo title={"Vendor"} />
                    <Pageheader breadcrumbs={['Apps', 'Marketplace']} currentpage="Vendor" Updated={true} />
                </div>
            </div>
            {/* <!-- End:: Breadcrumb--> */}
                        ...
                        <div className="grid grid-cols-12 gap-x-6 gap-y-2">
                            <div className="md:col-span-8 lg:col-span-9 col-span-12">
                                <div className="flex items-center flex-wrap gap-x-4">
                                    ...
                                    <div>
                                        <h4 className="font-semibold mb-0 flex items-center"><Link scroll={false} href="#!"> sprukotechnologies</Link></h4>
                                        ...
                                        <span className="badge badge-md bg-info/[0.15] text-info"><i className="bi bi-bar-chart-fill me-2"></i> 156 Sales</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="tab-pane border-0 p-0 show active" id="tab1" role="tabpanel" aria-labelledby="tab-1">
                            <div className="box">
                                <div className="box-header">
                                    ...
                                    <div>
                                        <p className="font-semibold mb-2">Profile 60% completed - <Link scroll={false} href="javscript:void(0);" className="text-primary text-[0.75rem]">Finish now</Link></p>
                                ...
                                <div className="box-body">
                                    <div className="grid grid-cols-12 gap-6 mb-6">
                                        ...
                                        <div className="xl:col-span-6 col-span-12">
                                            ...
                                            <input type="text" className="form-control" id="company-name" placeholder="Company Name" defaultValue="Spruko Technologies PRIVATE LIMITED" />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                            <label htmlFor="company-website" className="ti-form-label">Company Website</label>
                                            <input type="text" className="form-control" id="company-website" placeholder="Company Website" defaultValue="https://spruko.com" />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                        ...
                                        <div className="xl:col-span-6 col-span-12">
                                            <label htmlFor="featured-select" className="ti-form-label">Featured Item :</label>
                                    ...
                                    <div className="grid grid-cols-12 gap-6">
                                        ...
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">Company Banner Image :</label>
                                        ...
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">Company Logo :</label>
                                            <div> <label htmlFor="small-file-input3" className="sr-only">Choose file</label> <input type="file" name="small-file-input3" id="small-file-input3" className="block w-full border border-defaultborder focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-defaultborder dark:focus:border-white/10 dark:border-white/10 dark:text-white/50
                                                file:border-0
                                               file:bg-light file:me-4
                                               file:py-2 file:px-4
                                               dark:file:bg-black/20 dark:file:text-white/50" />
                                        ...
                                        <div className="xl:col-span-12 col-span-12">
                                            <div className="mb-4">
                                                <span className="avatar avatar-lg avatar-rounded">
                                                    ...
                                                    <Link scroll={false} href="#!" className="badge !rounded-full text-white bg-danger avatar-badge"><i className="fe fe-x"></i></Link>
                                                </span>
                                            </div>
                                            <div className="btn-list">
                                                <div> <label htmlFor="small-file-input2" className="sr-only">Choose file</label> <input type="file" name="small-file-input2" id="small-file-input2" className="block w-full border border-defaultborder focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-defaultborder dark:focus:border-white/10 dark:border-white/10 dark:text-white/50
                                                    file:border-0
                                                   file:bg-light file:me-4
                                                   file:py-2 file:px-4
                                                   dark:file:bg-black/20 dark:file:text-white/50" />
                            ...
                            <div className="box">
                                ...
                                <div className="box-body !p-0">
                                    <div className="table-responsive">
                                        <Spktables tableClass="ti-custom-table ti-custom-table-head w-full" showCheckbox={true} header={[{ title: 'Product Name' }, { title: 'Category' }, { title: 'Status' }, { title: 'Sell' }, { title: 'Published Date' }, { title: 'Featured' }, { title: 'Price' }, { title: 'Action' },]}>
                                            {AllProducts.map((idx) => (
                                                <tr key={idx.id}>
                                                    ...
                                                    <td>
                                                        <div className="flex">
                                                            <span className="avatar avatar-md avatar-square"><Image fill src={idx.src} className="w-100 h-100" alt="..." /></span>
                                                            <div className="ms-2">
                                                                <p className="font-semibold mb-0 flex items-center"><Link scroll={false} href="#!">{idx.name}</Link></p>
                                                                <p className="text-[0.75rem] text-muted mb-0">4-Bds - 4 Ba - 600ff3</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>{idx.category} </td>
                                    ...
                                    <div className="flex items-center flex-wrap overflow-auto">
                                        ...
                                        <div className="ms-auto">
                                            <ul className="ti-pagination mb-0 overflow-auto">
                                                ...
                                                <li className="page-item" aria-current="page"><Link scroll={false} className="page-link" href="#!">1</Link></li>
                        ...
                        <div className="tab-pane border-0 p-0 hidden" id="tab3" role="tabpanel" aria-labelledby="tab-3">
                            <div className="box">
                                ...
                                <div className="box-body">
                                    <div className="grid grid-cols-12 gap-6">
                                        <div className="xl:col-span-6 col-span-12">
                                            <label htmlFor="item-name" className="ti-form-label">Item Name</label>
                                            <input type="text" className="form-control" id="item-name" placeholder="Item Name" defaultValue="HTML Modern Template" />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">Item Category</label>
                                            <SpkSelect option={Itemdata} mainClass="  basic-multi-select" name="Category-select"
                                                menuplacement='auto' classNameprefix="Select2"
                                            />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">Featured</label>
                                            <SpkSelect option={Featuredata} mainClass="  basic-multi-select" name="Featured"
                                                menuplacement='auto' classNameprefix="Select2"
                                            />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">Compatible Browsers</label>
                                            <SpkSelect multi option={Compatibledata} mainClass="  basic-multi-select" name="browsers" id="browsers"
                                                menuplacement='auto' classNameprefix="Select2" defaultvalue={[Compatibledata[0], Compatibledata[1]]}
                                            />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">Files Included</label>
                                            <SpkSelect multi option={Filesdata} mainClass="  basic-multi-select" name="files" id="files"
                                        ...
                                        <div className="xl:col-span-6 col-span-12">
                                            <label htmlFor="tags" className="ti-form-label">Tags</label>
                                            <SpkSelect multi option={Tagsdata} mainClass="  basic-multi-select" name="tags" id="tags"
                                                menuplacement='auto' classNameprefix="Select2" defaultvalue={[Tagsdata[0], Tagsdata[1]]}
                                            />
                                        </div>
                                        <div className="xl:col-span-6 col-span-12">
                                            <label className="ti-form-label">High Resolution</label>
                                            <SpkSelect option={Featuredata} mainClass="  basic-multi-select" name="Category-select"
                                                menuplacement='auto' classNameprefix="Select2"
                                            />
                                        ...
                                        <div className="xl:col-span-12 col-span-12">
                                            <label htmlFor="bio" className="ti-form-label">Item Description :</label>
                            ...
                            <div className="box">
                                <div className="box-header justify-between">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <div className="ti-dropdown hs-dropdown">
                                            <Link scroll={false} href="#!"
                                                className="ti-btn ti-btn-primary ti-btn-sm btn-wave waves-effect waves-light !m-0"
                                            ...
                                            <ul className="ti-dropdown-menu hs-dropdown-menu hidden" role="menu">
                                                <li><Link scroll={false} className="ti-dropdown-item" href="#!">New</Link></li>
                                                <li><Link scroll={false} className="ti-dropdown-item" href="#!">Popular</Link></li>
                                                <li><Link scroll={false} className="ti-dropdown-item" href="#!">Relevant</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div className="box-body !p-0">
                                    <div className="table-responsive">
                                        <Spktables tableClass="ti-custom-table ti-custom-table-head w-full" header={[{ title: 'Order ID' }, { title: 'Product Name' }, { title: 'Customer' }, { title: 'Status' }, { title: 'Download Date' }, { title: 'Licence' }, { title: 'Price' }, { title: 'Action' },]}>
                                            {Downloads.map((idx) => (
                                                <tr key={idx.id}>
                                                    <td>
                                                        ...
                                                        <div className="flex items-center">
                                                            <div className="leading-none">
                                                                <span className="avatar avatar-sm avatar-rounded me-2">
                                                                    <Image fill src={idx.productSrc} alt="" />
                                                                </span>
                                                            </div>
                                                    ...
                                                    <td>
                                                        <span className={`badge ${idx.status === 'Refund' ? '!rounded-full badge-sm bg-danger/[0.15] text-danger' : '!rounded-full badge-sm bg-success/[0.15] text-success'} `}>{idx.status}</span>
                                                    </td>
                                                    <td>{idx.downloadDate}</td>
                                                    <td>
                                                        <span className={`badge ${idx.licence === 'Regular' ? '!rounded-full badge-sm bg-success/[0.15] text-success' : '!rounded-full badge-sm bg-warning/[0.15] text-warning'} `}>{idx.licence}</span>
                                                    </td>
                                                    <td className="font-semibold">{idx.price}</td>
                                                    <td>
                                                        <button className="ti-btn ti-btn-sm ti-btn-outline-light btn-wave">
                                        ...
                                        <div className="xl:col-span-11 col-span-12">
                                            ...
                                            <div className="grid grid-cols-12 gap-x-6 mb-6">
                                                <div className="xl:col-span-3 col-span-12">
                                                    ...
                                                    <p className="text-[0.75rem] mb-0 text-muted">Select the account type</p>
                                                </div>
                                            ...
                                            <div className="flex items-top mb-4 justify-between">
                                                <div>
                                                    <p className="text-[0.875rem] mb-1 font-semibold">Two Step Verification</p>
                                                    <p className="text-[0.75rem] text-muted mb-0">Two step verificatoin is very secured and restricts in happening faulty practices.</p>
                                                </div>
                                                <div className="custom-toggle-switch toggle-sm ms-sm-2 ms-0 mt-3">
                                            ...
                                            <div className="sm:flex block items-top mb-4 justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-[0.75rem] text-muted mb-0">Incase of forgetting password mails are sent to  heifo@gmail.com</p>
                                                </div>
                                            ...
                                            <div className="sm:flex block items-top justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-[0.75rem] text-muted mb-0">SMS are sent to 9102312xx in case of recovery</p>
                                                </div>
                                                <div className="custom-toggle-switch toggle-sm ms-sm-2 ms-0">
                                            ...
                                            <div className="grid grid-cols-12 gap-x-6">
                                                <div className="sm:col-span-6 col-span-12 mb-2">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" value="" id="itemupdate" defaultChecked />
                                                ...
                                                <div className="sm:col-span-6 col-span-12 mb-2">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" value="" id="itemcomment" />
                                                ...
                                                <div className="sm:col-span-6 col-span-12 mb-0">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" value="" id="itemreview" />
                                                ...
                                                <div className="sm:col-span-6 col-span-12 mb-0">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox" value="" id="itembuyerreview" defaultChecked />
                ...
                <div className="grid grid-cols-12 gap-x-6 justify-center">
                    ...
                    <div className="lg:col-span-6 col-span-10 text-center">
                        ...
                        <div className="btn-list">
                            ...
                            <Link href="#!" className="ti-btn ti-btn-lg ti-btn-danger"><i className="bi bi-send me-1"></i> Signup Now</Link>
                        </div>
                    </div>
                    <div className="lg:col-span-3 col-span-1 text-center"></div>
                </div>
