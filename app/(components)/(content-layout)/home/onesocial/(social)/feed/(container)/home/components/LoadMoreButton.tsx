  ...
  return (
    <div className="mt-5 mb-5">
      <button
        ...
        className={clsx(
          'px-6 py-2.5 mb-4 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-lg font-medium transition-all duration-300 relative overflow-hidden',
          { 'opacity-75 cursor-not-allowed': isLoadButton }
        )}
      ...
      >
        ...
        {/* Button Text */}
        <span className={clsx('transition-opacity duration-300', { 
