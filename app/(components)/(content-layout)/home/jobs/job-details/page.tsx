...
const JobDetails = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader Heading="Job Details" breadcrumbs={['Apps', 'Jobs']} currentpage="Job Details" />
            {/* <!-- Page Header Close --> */}
                ...
                <div className="xl:col-span-8 col-span-12">
                            ...
                            <div className="flex flex-wrap items-top justify-between gap-2">
                                <div>
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h4 className="font-medium mb-0 flex items-center"><Link scroll={false} href="#!">UI Developer - Fresher</Link></h4>
                                            <Link scroll={false} href="#!" className="font-medium"><i className="bi bi-building"></i> Spruko Technologies PRIVATE LIMITED</Link>
                                            <div className="flex text-[0.875rem] mt-4">
                                                ...
                                                <div className="ms-4">
                                                    <p className="mb-1"><i className="bi bi-coin me-1"></i><span className="font-medium">10,000 - 20,000</span> / per month (+incentives)</p>
                                                    <p><i className="bi bi-mortarboard  me-1"></i>Graduate and Above</p>
                                                </div>
                                            </div>
                                            <div className="popular-tags mt-4">
                                                <SpkBadge variant="info/[0.15]" customClass="!rounded-full  text-info me-1"><i className="bi bi-clock me-1"></i>Full Time</SpkBadge>
                                                <SpkBadge variant="danger/[0.15]" customClass="!rounded-full  text-danger"><i className="bi bi-briefcase me-1"></i>13 Openings</SpkBadge>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div className="btn-list mb-2">
                                        <Link scroll={false} href="#!" className="ti-btn ti-btn-primary me-2"> Apply Now</Link>
                                    ...
                                    <p className="mb-0"><i className="bi bi-info-circle text-danger" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="45 days left"></i> <span className="font-medium">45 days left </span> to apply this job</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="box">
                        <div className="box-body">
                            <div className="box-body">
                                ...
                                <p className="opacity-90 pb-4">Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labore no sed ipsum ipsum nonumy vero sanctus labore.A officiis optio temporibus minima facilis...</p>
                                <p className="mb-4 opacity-90 pb-4">Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labore no sed ipsum ipsum nonumy vero sanctus labore..</p>
                                ...
                                <ol className="ti-list-group !border-0 ti-list-unstyled list-decimal mb-4 ps-[2rem]">
                                    <li className="ti-list-group-item !border-0 !py-1">Design thoughtful, beautiful, and useful software user interfaces and experiences in a team environment..</li>
                                    <li className="ti-list-group-item !border-0 !py-1">Create user-centered designs by considering market analysis, customer feedback, site metrics, and usability findings.</li>
                                    <li className="ti-list-group-item !border-0 !py-1">Work with stakeholders to plan projects for effective delivery while maintaining high standards for design..</li>
                                    <li className="ti-list-group-item !border-0 !py-1">Be a passionate and effective advocate for design with non-design audiences..</li>
                                    <li className="ti-list-group-item !border-0 !py-1">Use business requirements, user and market research to assist in developing scenarios, use cases, and high-level requirements..</li>
                                </ol>
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 sm:gap-x-6 items-center">
                                <div className="lg:col-span-6 col-span-12">
                                    <h5 className="font-medium mb-0">&#128400; Was this job fit for someone?</h5>
                                </div>
                    ...
                    <div className="grid grid-cols-12 gap-x-6">
                        <div className="xl:col-span-12 col-span-12">
                            ...
                            <SpkSwiperJs spaceBetween={30} slidesPerView={2} slides={SwiperComponent} breakpoint={breakpoints} navigation={true} autoplay={true}
                ...
                <div className="xl:col-span-4 col-span-12">
                    ...
                    <div className="box border overflow-hidden">
                        <div className="box-header justify-between">
                            ...
                            <Link scroll={false} href="#!" className="text-primary font-medium text-[0.8125rem]">
                            ...
                            <ul className="ti-list-group ti-list-group-flush">
                                ...
                                <li className="ti-list-group-item mb-2">
                                    <div className="sm:flex">
                                        ...
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.8125rem] mb-1"><Link scroll={false} href="#!"> HTML Developer - Fresher</Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-building text-textmuted dark:text-textmuted/50"></i>  Spruko Technologies PRIVATE LIMITED</p>
                                        </div>
                                    </div>
                                </li>
                                <li className="ti-list-group-item mb-2">
                                    <div className="sm:flex">
                                        ...
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.8125rem] mb-1"><Link scroll={false} href="#!"> Wordpress Developer - Remote</Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-building text-textmuted dark:text-textmuted/50"></i> Hardware Private Solutions</p>
                                        </div>
                                    </div>
                                </li>
                                <li className="ti-list-group-item">
                                    <div className="sm:flex">
                                        ...
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.8125rem] mb-1"><Link scroll={false} href="#!"> Vuejs Frontend Developer</Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-building text-textmuted dark:text-textmuted/50"></i> G Technical Solutions</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div className="box border">
                        ...
                        <div className="box-body !p-0">
                            <ul className="ti-list-group ti-list-group-flush">
                                <li className="ti-list-group-item mb-2">
                                    <div className="sm:flex">
                                        <span className="avatar avatar-md avatar-rounded bg-gray-300 border">
                                            <Image fill src="../../../assets/images/company-logos/3.png" alt="" />
                                        </span>
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.875rem] mb-1"><Link scroll={false} href="#!">Infratech PVT LTD</Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-briefcase text-textmuted dark:text-textmuted/50"></i> React Lead Developer </p>
                                        </div>
                                    </div>
                                </li>
                                <li className="ti-list-group-item mb-2">
                                    <div className="sm:flex">
                                        ...
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.875rem] mb-1"><Link scroll={false} href="#!">Spruko Technologies PRIVATE LIMITED</Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-briefcase text-textmuted dark:text-textmuted/50"></i>  HTML Developer - Fresher</p>
                                        </div>
                                    </div>
                                </li>
                                <li className="ti-list-group-item mb-2">
                                    <div className="sm:flex">
                                        ...
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.875rem] mb-1"><Link scroll={false} href="#!">Hardware Private Solutions </Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-briefcase text-textmuted dark:text-textmuted/50"></i> Wordpress Developer</p>
                                        </div>
                                    </div>
                                </li>
                                <li className="ti-list-group-item mb-2">
                                    <div className="sm:flex">
                                        ...
                                        <div className="ms-3 flex-grow">
                                            <p className="font-medium text-[0.875rem] mb-1"><Link scroll={false} href="#!"> G Technical Solutions</Link></p>
                                            <p className="mb-0 me-3"><i className="bi bi-briefcase text-textmuted dark:text-textmuted/50"></i> Vuejs Frontend Developer</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
