...
import { RefundRequestsdata } from "@/shared/data/apps/ecommers/admin/refund-requests-data";
    ...
    return (
        <Fragment>
            <div className="container-fluid">
                ...
                <Pageheader Heading="Refund Requests" breadcrumbs={['Apps', 'Ecommerce', 'Admin']} currentpage="Refund Requests" />
                {/* <!-- Page Header Close --> */}
                        ...
                        <div className="box overflow-hidden">
                            ...
                            <div className="box-body !p-0">
                                <div className="table-responsive">
                                    <Spktables tableClass="ti-custom-table ti-custom-table-head w-full" header={[{ title: 'Order Id' }, { title: 'Product', }, { title: 'Customer', }, { title: 'Mobile Number' }, { title: 'Ordered Date' }, { title: 'Payment Mode' }, { title: 'Cost' }, { title: 'Status' }, { title: 'Action' },]}>
                                        {RefundRequestsdata.map((idx) => (
                                            <tr key={idx.id}>
                                                <td>{idx.id}</td>
                                                <td>
                                                    <div className="flex items-center">
                                                        <span className="avatar custom-img avatar-sm avatar-square bg-gray-300 dark:bg-light"><Image fill src={idx.productSrc} className="w-100 h-100" alt="..." /></span>
                                                        <div className="ms-2">
                                                ...
                                                <td>
                                                    <Link scroll={false} href="/apps/ecommerce/admin/order-details" className="ti-btn ti-btn-icon ti-btn-sm ti-btn-soft-primary btn-wave">
                            ...
                            <div className="box-footer">
                                <div className="flex items-center flex-wrap overflow-auto">
                                    <div className="mb-2 mb-sm-0">
                                        Showing <b>1</b> to <b>8</b> of <b>10</b> entries <i className="bi bi-arrow-right  rtl:rotate-180 inline-flex  ms-2 font-semibold"></i>
                                    </div>
