    ...
    <div className="block md:hidden fixed bottom-0 left-0 right-0">
      <div className="flex text-gray-700 dark:text-gray-300 *:flex *:items-center">
        <div
          ...
          <Link href="/home/instagram" className="">
            <HomeIcon/>
          </Link>
          <Link href="/home/instagram/search" className="">
            <SearchIcon/>
          </Link>
        </div>
        ...
        <div
          ...
          <Link href="/home/instagram/browse" className="text-ig-red dark:text-ig-orange">
            <LayoutGridIcon/>
          </Link>
          <Link href="/home/instagram/profile" className=" ">
            <UserIcon/>
          </Link>
        </div>
      </div>
