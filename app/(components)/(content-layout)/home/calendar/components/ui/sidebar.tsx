...
import { Sheet, SheetContent } from "@/app/projects/components/ui/sheet";
import { Skeleton } from "@/app/projects/components/ui/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <ChevronsLeftIcon className="!w-5 !h-5 !stroke-2" />
  ...
  return (
    <main
      ...
      className={cn(
        ...
        className,
        state !== "collapsed" ? "pl-[260px]" : "pl-[50px]",
        isMobile ? "pl-0" : ""
      )}
      {...props}
    />
