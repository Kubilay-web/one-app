...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/app/(components)/(content-layout)/medical/components/ui/tabs";
...
import { Button } from "@/app/(components)/(content-layout)/medical/components/ui/button";
