...
const carouselItems = [
  {
    image: "/onemedical/images/1.jpg",
    title: "Join Our Network,",
    subtitle: "Transform Healthcare",
  },
  {
    image: "/onemedical/images/2.jpg",
    title: "Empower Patients,",
    subtitle: "Anytime, Anywhere",
  },
  {
    image: "/onemedical/images/3.jpg",
...
export default function SignupCarousel() {
  ...
  return (
    <div className="relative w-full h-full bg-purple-900 rounded-l-lg overflow-hidden">
