...
import { updateSpecialty,createSpecialty,createManySpecialties } from "../../actions/specialities";
...
export default function SpecialtyForm({
  ...
  async function onSubmit(data: SpecialtyProps) {
    ...
    reset();
    router.push("/medical/dashboard/specialties");
  }
    ...
    <div className="w-full max-w-2xl shadow-sm rounded-md m-3 border border-gray-200 mx-auto">
      <div className="text-center border-b border-gray-200 py-4 dark:border-slate-600">
        <div className="flex items-center justify-between px-6">
          ...
          <Button asChild variant={"outline"}>
            <Link href="/medical/dashboard/specialties">
              <X className="w-4 h-4" />
            </Link>
          </Button>
        </div>
      ...
      <form className=" py-4 px-4  mx-auto " onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-8 flex justify-between gap-4 items-center">
          <Button asChild variant={"outline"}>
            <Link href="/medical/dashboard/specialties">Cancel</Link>
          </Button>
          <Button asChild variant={"outline"}>
