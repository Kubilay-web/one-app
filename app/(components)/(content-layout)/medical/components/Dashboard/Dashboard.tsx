...
import { PatientProps } from "../../back/dashboard/doctors/layout";
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button asChild>
                <Link href="/medical/dashboard/doctors">View All</Link>
              </Button>
            </div>
          </CardHeader>
                  ...
                  <div key={doctor.id} className="flex items-center gap-4">
                    ...
                    <div className="ml-auto font-medium flex space-x-2 items-center">
                      <Button size={"sm"} asChild variant={"outline"}>
                        <Link href={`/medical/dashboard/doctors/view/${doctor.id}`}>
                          View
                        </Link>
                      </Button>
                      <ApproveBtn
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button asChild>
                <Link href="/medical/dashboard/patients">View All</Link>
              </Button>
            </div>
          </CardHeader>
          <CardContent className="grid gap-8">
                ...
                return (
                  <div key={patient.email} className="flex items-center gap-4">
                    ...
                    <div className="ml-auto font-medium flex space-x-2 items-center">
                      <Button size={"sm"} asChild variant={"outline"}>
                        <Link
                          href={`/medical/dashboard/patients/view/${patient.patientId}`}
                        >
                          View
                        </Link>
                      </Button>
