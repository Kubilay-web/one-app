...
import { getDoctors } from "@/app/(components)/(content-layout)/medical/actions/users";
import DoctorCard from "@/app/(components)/(content-layout)/medical/components/DoctorCard";
