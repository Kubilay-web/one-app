          ...
          {Object.entries(storeGroupedItems).map(([storeId, storeItems]) => {
            ...
            return (
              <div key={storeId} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
                ...
                <div>
                  {storeItems.map((item) => (
                    <div key={item.id} className="p-6 border-t border-gray-100 dark:border-gray-700">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    disabled={!!cart?.coupon || isApplyingCoupon}
                  ...
                  {cart?.coupon ? (
                    <button
                      ...
                      className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Remove
                    </button>
                  ) : (
                ...
                {cart?.coupon && (
                  <div className="mt-2">
                    <span className="inline-flex items-center px-2 py-1 rounded-md bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 text-sm">
