...
export default function ApplySellerMultiForm() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen lg:h-screen overflow-hidden">
      {/* Instructions */}
      <div className="w-full lg:w-1/2 lg:h-full lg:overflow-y-auto p-5 bg-gray-50">
        <Instructions />
      </div>

      {/* Form */}
      <div className="relative w-full lg:w-1/2 lg:h-full lg:overflow-y-auto p-5 flex flex-col">
        <ProgressBar step={step} />
