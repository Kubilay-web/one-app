...
const bannerSlides = [
  <div key={1} className="relative w-full h-full">
    <Image
      src="../../../assets/images/ecommerce/banner/1.png"
      alt="Summer Sale"
      fill
    ...
    <div className="absolute inset-0 bg-black/30 flex flex-col justify-center items-start p-8">
      ...
      <p className="text-white text-lg mb-4">Up to 50% off on all items</p>
      <Link
  ...
  <div key={2} className="relative w-full h-full">
    <Image
      src="../../../assets/images/ecommerce/banner/2.png"
      alt="New Arrivals"
      fill
      className="object-cover"
      priority
    ...
    <div className="absolute inset-0 bg-black/30 flex flex-col justify-center items-start p-8">
      ...
      <p className="text-white text-lg mb-4">Check out our latest collection</p>
      <Link
        href="/ecommerce/customer/shop"
        className="ti-btn ti-btn-primary ti-btn-lg"
      >
  ...
  <div key={3} className="relative w-full h-full">
    <Image
      src="../../../assets/images/ecommerce/banner/4.png"
      alt="Free Shipping"
      fill
      className="object-cover"
      priority
    ...
    <div className="absolute inset-0 bg-black/30 flex flex-col justify-center items-start p-8">
      ...
      <p className="text-white text-lg mb-4">On orders over $100</p>
      <Link
        href="/ecommerce/customer/shop"
        className="ti-btn ti-btn-primary ti-btn-lg"
      >
...
const TopCategories = [
  ...
  { id: 4, title: "Beauty", icon: "sparkles", colorClass: "danger", items: 42 },
  {
    id: 5,
    title: "Sports",
    icon: "dumbbell",
  ...
  { id: 6, title: "Books", icon: "book", colorClass: "info", items: 56 },
];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [productsRes, homeDataRes] = await Promise.all([
          fetch("/api/oneshop/products?limit=100"),
          fetch("/api/oneshop/homedata"),
        ]);

        if (!productsRes.ok || !homeDataRes.ok) {
          throw new Error("Failed to fetch data");
        }

        const productsData = await productsRes.json();
        const homeDataJson = await homeDataRes.json();

        if (productsData.success) {
          setProducts(productsData.products);
        }

        if (homeDataJson.success) {
          setHomeData(homeDataJson.data);
        }
      } catch (error) {
  ...
  return (
    <Fragment>
      ...
      <div className="main-content landing-main ecommerce-main">
            ...
            <div className="grid grid-cols-12 gap-x-6">
              ...
              {homeData?.categories?.slice(0, 6).map((category) => (
                <div
                  ...
                  key={category.id}
                >
                  <div className="link-tag link-tag-primary !rounded-full">
                    <Link
                      scroll={false}
                      href={`/ecommerce/customer/shop?category=${category.url}`}
                      className="stretched-link"
                    ></Link>
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-grow link-tag-body">
                        <p className="mb-0 text-truncate">{category.name}</p>
                    ...
                    <div className="flex items-start mb-4">
                      <div className="flex-grow">
                        ...
                        <p className="mb-0 text-textmuted dark:text-textmuted/50">
                          Explore now and get 30% discount on Household
                          appliances
                        </p>
                      </div>
                      <div className="min-w-fit">
        ...
        <section className="section">
          <div className="container">
            <div className="grid grid-cols-12 gap-x-6">
              ...
              {homeData?.popularProducts?.slice(0, 8).map((product) => {
                const variant = product.variants[0];
                const size = variant?.sizes[0];
                        ...
                        <div className="p-4">
                          <div className="flex items-start justify-between">
                            <div className="flex-grow">
                              <Link
                                scroll={false}
                                href={`/ecommerce/customer/shop?brand=${product.brand}`}
          ...
          <div className="container">
            <div className="grid grid-cols-12 gap-x-6 justify-center">
              ...
              <div className="lg:col-span-10 col-span-12 text-center">
                <div className="mb-4">
                  <h2 className="font-medium mb-2 mt-2 !text-white">
        ...
        <section className="section">
          <div className="container">
            <div className="grid grid-cols-12 gap-x-6">
              ...
              {homeData?.specialOffers?.slice(0, 3).map((product) => {
                const variant = product.variants[0];
                const size = variant?.sizes[0];
                const discount = size?.discount || 0;
                const currentPrice = size
        ...
        {/* <!-- Start:: Section-7 --> */}
        <section className="section bg-white dark:bg-bodybg mt-5">
          <div className="container">
            <div className="grid grid-cols-12 sm:gap-x-6">
              <div className="xl:col-span-12 col-span-12">
                <div className="flex justify-between items-baseline flex-wrap gap-2 mb-4">
                  <div className="heading-section !text-start">
                    <div className="heading-title">Featured Products</div>
                    <div className="heading-description">
                  ...
                  >
                    <div className="box card-style-2">
                      <div className="box-body !p-0">
                        ...
                        <div className="badge top-right-badge bg-info !text-white">
                          <div className="badge-icon">
                            <i className="ti ti-star text-[0.875rem]"></i>
                          </div>
                          ...
                          <div className="mt-3">
                            ...
                            >
                              <div
                                ...
                                style={{
                                  width: `${Math.min(100, (product.sales / 1000) * 100)}%`,
                                }}
                              ></div>
                            </div>
                          </div>
        ...
        <section className="section">
          <div className="container">
            <div className="grid grid-cols-12 gap-x-6">
              ...
              {homeData?.newArrivals?.slice(0, 6).map((product) => {
                const variant = product.variants[0];
                const size = variant?.sizes[0];
            ...
            <div className="grid grid-cols-12 gap-x-6">
              ...
              <div className="xl:col-span-12 col-span-12">
                ...
                <div className="tab-content all-products">
                  ...
                  {/* Diğer tab panelleri benzer şekilde implement edilebilir */}
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="section bg-banner lg:px-0 px-4 !py-[4.375rem]">
          <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="lg:col-span-6 col-span-10 text-center">
              ...
              <div className="btn-list flex justify-center gap-4">
                <Link
                  scroll={false}
                  href="#!"
                  className="ti-btn bg-black app-store relative px-8 py-3"
                >
                  <div className="flex items-center gap-2">
