    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          ...
          variant="outline"
          className="
            w-full lg:w-auto h-9 px-3 rounded-md font-normal
      ...
      <PopoverContent
        align="start"
        className="
          w-full lg:w-auto p-0 bg-white text-black border border-gray-200 shadow-md
        "
      >
        <Calendar
          mode="range"
        ...
        <div className="p-4 w-full flex flex-col sm:flex-row gap-2 border-t border-gray-200">
          <PopoverClose asChild>
            <Button
              onClick={onReset}
              disabled={!date?.from || !date?.to}
              variant="outline"
              className="w-full sm:w-auto text-black border-gray-300 hover:bg-gray-100"
            >
              Reset
            </Button>
          </PopoverClose>
