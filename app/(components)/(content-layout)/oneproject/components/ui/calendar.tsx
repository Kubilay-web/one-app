    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white p-0 text-black opacity-70 hover:opacity-100"
        ),
        ...
        head_row: "flex",
        head_cell:
          "rounded-md w-9 font-normal text-[0.8rem] text-black",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-black hover:bg-gray-100 aria-selected:opacity-100"
        ),
        day_selected:
        ...
        day_outside:
          "text-gray-400 aria-selected:bg-gray-200 aria-selected:text-gray-500",
