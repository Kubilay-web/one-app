...
export const columns: ColumnDef<Student>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div>
          <h2 className="font-medium text-sm">{student.regNo}</h2>
          <p className="text-sm text-muted-foreground">
            Guardian: {student.parentName}
          </p>
        </div>
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div>
          <h2 className="font-medium text-sm">{student.classTitle ?? ""}</h2>
          <p className="text-sm text-muted-foreground">{student.streamTitle ?? ""}</p>
        </div>
      );
    },
  },
