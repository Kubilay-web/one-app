...
const Profile = async () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6 px-3 sm:px-5">

      {/* ================= PROFILE CARD ================= */}
      <div className="flex flex-col sm:flex-row items-center gap-5 rounded-xl bg-white p-4 sm:p-6 shadow-md">
        ...
        <div className="flex-shrink-0">
          {user.avatarUrl ? (
            <img
              src={user.avatarUrl}
              alt="Profile"
              className="h-[110px] w-[110px] sm:h-[130px] sm:w-[130px] lg:h-[150px] lg:w-[150px] rounded-full object-cover"
            />
          ) : (
            <label
              htmlFor="img"
              className="flex h-[110px] w-[110px] sm:h-[130px] sm:w-[130px] lg:h-[150px] lg:w-[150px] cursor-pointer flex-col items-center justify-center rounded-full border-2 border-dashed border-gray-300 bg-gray-100 text-gray-500 transition hover:bg-gray-200"
            >
              <FaImage className="text-2xl sm:text-3xl lg:text-4xl" />
              <span className="mt-1 text-xs sm:text-sm">Select Image</span>
            </label>
        ...
        <div className="w-full flex flex-col gap-4 text-gray-700">
          ...
          <div className="flex flex-col">
            ...
            <input
              type="text"
              value={user.username}
              className="mt-1 w-full border-b border-gray-300 text-base sm:text-lg font-semibold outline-none focus:border-blue-500"
            />
          </div>
      ...
      {/* ================= PASSWORD CARD ================= */}
      <div className="rounded-xl bg-white p-4 sm:p-6 shadow-md text-gray-700">

        <h2 className="mb-6 text-center text-lg sm:text-xl font-bold">
          Change Password
        </h2>
        ...
        <form className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              name="old_password"
              placeholder="Enter Old Password"
              className="mt-2 w-full rounded-md border border-gray-300 px-3 py-2 text-sm sm:text-base outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <button
            type="submit"
            className="mt-4 w-full rounded-md bg-blue-500 py-2 text-sm sm:text-base font-semibold text-white transition hover:bg-blue-700"
          >
            Change Password
          </button>
