...
//             className="h-10 w-full rounded-md border border-gray-300 px-4 py-2 outline-none transition focus:border-blue-500 disabled:bg-gray-100"
//           >
//             <option value="">
...
//           <label
//             htmlFor="img"
//             className="flex h-[240px] w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-500 text-gray-500 transition hover:border-blue-500"
//           >
//             {img ? (
//               <img
//                 src={img}
...
//             type="submit"
//             disabled={loader}
//             className="rounded-md bg-blue-500 px-3 py-[6px] text-white hover:bg-blue-800 disabled:opacity-60"
//           >
//             {loader ? "Loading..." : "Add News"}
//           </button>
//         </div>
...
const CreateNews = () => {
  ...
  const added = async (e: React.FormEvent) => {
    e.preventDefault();
