...
//       router.push(`/dashboards/ecommerce/seller/stores/${params.storeUrl}/products`);
//     } catch (error) {
...
//             <button
//               type="button"
//               onClick={() => router.push(`/dashboards/ecommerce/seller/stores/${params.storeUrl}/products`)}
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 max-w-7xl">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="px-2 sm:px-3 py-1 bg-blue-100 text-blue-800 text-xs sm:text-sm font-medium rounded-full truncate max-w-[200px]">
              {storeInfo.name}
            </span>
          </div>
        </div>
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex items-center justify-center">
          <div className="flex items-center w-full max-w-md">
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 bg-blue-600 text-white rounded-full text-xs sm:text-sm">
                1
              </div>
              <span className="text-xs sm:text-sm mt-2 font-medium text-blue-600 hidden sm:block">Basic Info</span>
            </div>
            <div className="flex-1 h-0.5 bg-blue-600 mx-1 sm:mx-2"></div>
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 bg-blue-600 text-white rounded-full text-xs sm:text-sm">
                2
              </div>
              <span className="text-xs sm:text-sm mt-2 font-medium text-blue-600 hidden sm:block">Variants</span>
            </div>
            <div className="flex-1 h-0.5 bg-gray-200 mx-1 sm:mx-2"></div>
            <div className="flex flex-col items-center">
              <div className="flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 bg-gray-200 text-gray-600 rounded-full text-xs sm:text-sm">
                3
              </div>
              <span className="text-xs sm:text-sm mt-2 text-gray-600 hidden sm:block">Advanced</span>
            </div>
          </div>
        </div>
        <div className="flex justify-center gap-4 sm:hidden mt-3 text-xs text-gray-600">
          <span className="font-medium text-blue-600">Basic Info</span>
          <span className="font-medium text-blue-600">Variants</span>
          <span>Advanced</span>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-gray-900">Basic Information</h2>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm bg-blue-100 text-blue-800 font-medium"
                    >
                      {tag}
                      <button
                        type="button"
                        onClick={() => removeTag(tag)}
                        className="ml-1 sm:ml-2 hover:text-blue-600"
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Product Variants</h2>
            <button
              type="button"
              onClick={addVariant}
              className="px-3 sm:px-4 py-2 sm:py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2 font-medium text-sm sm:text-base w-full sm:w-auto justify-center"
            >
              <Plus className="h-4 w-4" />
              Add Variant
            </button>
          ...
          {variants.map((variant, variantIndex) => (
            <div key={variantIndex} className="border border-gray-200 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 last:mb-0">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-200">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">Variant {variantIndex + 1}</h3>
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor={`sale-${variantIndex}`} className="ml-2 text-xs sm:text-sm text-gray-700">
                      On Sale
                    </label>
                  </div>
                  <button
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                  <div className="flex flex-col items-center w-full sm:w-auto">
                    {variant.variantImage ? (
                      ...
                      <div className="w-32 h-32 sm:w-40 sm:h-40 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <label
                      htmlFor={`main-image-${variantIndex}`}
                      className={`inline-flex items-center px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 cursor-pointer font-medium text-sm sm:text-base ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                      {uploading ? 'Uploading...' : 'Choose Image'}
                    </label>
              ...
              <div className="mt-6 sm:mt-8">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 mb-4">
                  {variant.colors.map((color, colorIndex) => (
                    <div
                      key={colorIndex}
                      className="inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-2 bg-gray-100 text-gray-800 rounded-full text-xs sm:text-sm"
                    >
                      <div 
                ...
                <div className="flex flex-col sm:flex-row gap-3 max-w-md">
                  ...
                  <button
                    ...
                    className="px-4 sm:px-6 py-2 sm:py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 font-medium text-sm sm:text-base"
                  >
                    Add
                  </button>
                </div>
              ...
              <div className="mt-6 sm:mt-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-6">
                  <h4 className="text-base sm:text-lg font-semibold text-gray-900">Sizes and Prices *</h4>
                  <button
                    type="button"
                    onClick={() => addSize(variantIndex)}
                    className="px-3 sm:px-4 py-2 sm:py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm sm:text-base w-full sm:w-auto"
                  >
                    Add Size
                  </button>
                </div>
                            ...
                            <tr key={sizeIndex} className="hover:bg-gray-50">
                              <td className="px-3 sm:px-6 py-2 sm:py-4">
                                <input
                                  ...
                                  value={size.size}
                                  onChange={(e) => handleSizeChange(variantIndex, sizeIndex, 'size', e.target.value)}
                                  className="w-full px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                  placeholder="S,M,L"
                                  required
                                />
                               </td>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Specifications</h2>
            <button
              type="button"
              onClick={addSpec}
              className="px-3 sm:px-4 py-2 sm:py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2 font-medium text-sm sm:text-base w-full sm:w-auto justify-center"
              ...
              <div key={index} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <div className="sm:w-auto">
                  <button
                    type="button"
                    onClick={() => removeSpec(index)}
                    className="w-full sm:w-auto px-4 py-2 sm:py-3 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg font-medium text-sm sm:text-base"
                    disabled={specs.length === 1}
                  >
                    Remove
                  </button>
            ...
            {questions.map((question, index) => (
              <div key={index} className="border border-gray-200 rounded-xl p-4 sm:p-6">
                <div className="flex justify-between items-center mb-3 sm:mb-4">
                  <h4 className="text-base sm:text-lg font-semibold text-gray-900">Question {index + 1}</h4>
                  <button
                    type="button"
                    onClick={() => removeQuestion(index)}
                    className="text-red-600 hover:text-red-700"
        ...
        {/* Form Actions */}
        <div className="flex flex-col-reverse sm:flex-row justify-between items-center gap-4 pt-6 sm:pt-8 border-t border-gray-200">
          <div className="w-full sm:w-auto">
            <button
              type="button"
              onClick={() => router.push(`/dashboards/ecommerce/seller/stores/${params.storeUrl}/products`)}
              className="w-full sm:w-auto px-6 sm:px-8 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium text-sm sm:text-base"
              disabled={loading || uploading}
            >
              Cancel
            </button>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 font-medium text-sm sm:text-base"
              disabled={loading || uploading}
            >
              Save as Draft
            </button>
            ...
            <button
              type="submit"
              disabled={loading || uploading}
              className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center justify-center gap-2 text-sm sm:text-base"
            >
              {loading ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
