                ...
                <CommandItem
                  ...
                  className={cn("mt-1 h-12 w-full cursor-pointer", {
                    "bg-accent text-accent-foreground":
                      link.link === ""
                        ? pathname === `/dashboards/ecommerce/seller/stores/${activeStore}`
                        : `/dashboards/ecommerce/seller/stores/${activeStore}/${link.link}` ===
                          pathname,
                  })}
                >
                  <Link
                    href={`/dashboards/ecommerce/seller/stores/${activeStore}/${link.link}`}
