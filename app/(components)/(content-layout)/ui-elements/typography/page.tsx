...
const Typography = () => {
	return (
		<Fragment>
			...
			<Pageheader Heading="Typography" breadcrumbs={['Ui Elements']} currentpage="Typography" />
			{/* <!-- Page Header Close --> */}

			{/*<!-- Start::row-1 -->*/}
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 lg:col-span-12">
					<Showcode title="Heading tags" customCardBodyClass="space-y-3" reactCode={uiElementsPrism.typography1} >
				...
				<div className="col-span-12 lg:col-span-12">
					<Showcode title="Inline text elements" customCardBodyClass="space-y-3" reactCode={uiElementsPrism.typography2} >
				...
				<div className="col-span-12 lg:col-span-12">
					<Showcode title="Description list alignment" customCardBodyClass="space-y-3" reactCode={uiElementsPrism.typography3} >
				...
				<div className="col-span-12 lg:col-span-12">
					<Showcode title="First-line and first-letter" customCardBodyClass="space-y-8" reactCode={uiElementsPrism.typography4} >
				...
				<div className="col-span-12 lg:col-span-12">
					<Showcode title="Font Sizes" customCardBodyClass="space-y-3" reactCode={uiElementsPrism.typography5} >
				...
				<div className="col-span-12 lg:col-span-12">
					...
					<Showcode title="Open/closed state" customCardBodyClass="space-y-8" reactCode={uiElementsPrism.typography6} >
						<div className="">
					...
					<Showcode title="Text Decoration" customCardBodyClass="space-y-3" reactCode={uiElementsPrism.typography7} >
					...
					<Showcode title="Text Transform" customCardBodyClass="space-y-3" reactCode={uiElementsPrism.typography8} >
