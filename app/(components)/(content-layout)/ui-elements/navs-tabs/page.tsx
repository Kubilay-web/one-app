...
const NavsTabs: FC<NavsTabsProps> = () => {
  return (
    <Fragment>

      {/* <!-- Page Header --> */}
      <Seo title="Navs & Tabs" />
      <Pageheader Heading="Navs & Tabs" breadcrumbs={['Ui Elements']} currentpage="Navs & Tabs" />
      {/* <!-- Page Header Close --> */}
          ...
          <div className="box">
            ...
            <div className="box-body">
              <nav className="sm:flex space-x-6 rtl:space-x-reverse">
                <Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                  Link
                </Link>
                <Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" href="#!" aria-current="page">
                  Active
                </Link>
                <Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                  Link
                </Link>
                <Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" href="#!">
                  Disabled
                </Link>
              </nav>
            </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <ul className="list-disc space-x-6 rtl:space-x-reverse">
                <li className="inline-block"><Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                  Link
                </Link></li>
                <li className="inline-block"><Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" href="#!" aria-current="page">
                  Active
                </Link></li>
                <li className="inline-block"><Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                  Link
                </Link></li>
                <li className="inline-block"><Link scroll={false} className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" href="#!">
                  Disabled
                </Link></li>
              </ul>
            </div>
      ...
      <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="box-body">
              <div className="border-b-0 border-gray-200 dark:border-white/10">
                <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent dark:hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" Id="hs-tab-js-behavior-item-1" Tab="#hs-tab-js-behavior-1" Controls="hs-tab-js-behavior-1">
                    Tab 1
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent dark:hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" Id="hs-tab-js-behavior-item-2" Tab="#hs-tab-js-behavior-2" Controls="hs-tab-js-behavior-2">
                    Tab 2
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent dark:hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" Id="hs-tab-js-behavior-item-3" Tab="#hs-tab-js-behavior-3" Controls="hs-tab-js-behavior-3">
                    Tab 3
                  </SpkButton>
                </nav>
              </div>
              ...
              <div className="flex">
                <div className="border-e border-gray-200 dark:border-white/10">
                  <nav className="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" data-hs-tabs-vertical="true" role="tablist">
                    <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-e-transparent dark:hs-tab-active:border-e-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" Id="hs-tab-js-vertical-item-1" Tab="#hs-tab-js-vertical-1" Controls="hs-tab-js-vertical-1">
                      Tab 1
                    </SpkButton>
                    <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-e-transparent dark:hs-tab-active:border-e-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" Id="hs-tab-js-vertical-item-2" Tab="#hs-tab-js-vertical-2" Controls="hs-tab-js-vertical-2">
                      Tab 2
                    </SpkButton>
                    <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-e-transparent dark:hs-tab-active:border-e-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" Id="hs-tab-js-vertical-item-3" Tab="#hs-tab-js-vertical-3" Controls="hs-tab-js-vertical-3">
                      Tab 3
                    </SpkButton>
                  </nav>
                </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              <div className="hidden sm:block border-b-0 border-gray-200 dark:border-white/10">
                <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent dark:hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" Id="hs-tab-to-select-item-1" Tab="#hs-tab-to-select-1" Controls="hs-tab-to-select-1">
                    Tab 1
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent dark:hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" Id="hs-tab-to-select-item-2" Tab="#hs-tab-to-select-2" Controls="hs-tab-to-select-2">
                    Tab 2
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:bg-white hs-tab-active:border-b-transparent dark:hs-tab-active:border-b-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-bodybg dark:hs-tab-active:border-b-white/10 dark:hs-tab-active:text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300" Id="hs-tab-to-select-item-3" Tab="#hs-tab-to-select-3" Controls="hs-tab-to-select-3">
                    Tab 3
                  </SpkButton>
                </nav>
              </div>
            ...
            <div className="box-body">
              <div className="sm:border-b-2 border-gray-200 dark:border-white/10">
                <nav className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse" role="tablist">
                  <Link scroll={false} className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 hover:text-primary" href="#!" id="icon-item-1" data-hs-tab="#icon-1" aria-controls="icon-1">
            ...
            <div className="box-body">
              <div className="sm:border-b border-gray-200 dark:border-white/10">
                <nav className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <SpkButton buttontype="button" customClass="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active" Id="tabs-with-badges-item-1" Tab="#tabs-with-badges-1" Controls="tabs-with-badges-1">
                  ...
                  <SpkButton buttontype="button" customClass="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" Id="tabs-with-badges-item-2" Tab="#tabs-with-badges-2" Controls="tabs-with-badges-2">
                  ...
                  <SpkButton buttontype="button" customClass="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" Id="tabs-with-badges-item-3" Tab="#tabs-with-badges-3" Controls="tabs-with-badges-3">
                    Tab 3
                  </SpkButton>
                </nav>
              </div>
            ...
            <div className="box-body">
              <div className="border-b-0 border-gray-200 dark:border-white/10">
                <nav className="flex space-x-2 rtl:space-x-reverse" role="tablist">
                  <Link scroll={false} className="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor rounded-t-sm hover:text-gray-700 dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active" href="#!" id="card-type-item-1" data-hs-tab="#card-type-1" aria-controls="card-type-1">
                    Active
                  </Link>
            ...
            <div className="box-body">
              <div className="sm:flex bg-gray-100 hover:bg-gray-200 rounded-sm transition p-1 dark:bg-black/20 dark:hover:bg-black/20">
                <nav className="sm:flex sm:space-x-2 sm:rtl:space-x-reverse" role="tablist">
                  <Link scroll={false} className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-light dark:hs-tab-active:text-defaulttextcolor/70 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-defaulttextcolor hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" href="#!" id="segment-item-1" data-hs-tab="#segment-1" aria-controls="segment-1">
                    Active
                  </Link>
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 dark:hs-tab-active:bg-light dark:hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" Id="pills-on-gray-color-item-1" Tab="#pills-on-gray-color-1" Controls="pills-on-gray-color-1">
                  Tab 1
                </SpkButton>
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 dark:hs-tab-active:bg-light dark:hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="pills-on-gray-color-item-2" Tab="#pills-on-gray-color-2" Controls="pills-on-gray-color-2">
                  Tab 2
                </SpkButton>
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 dark:hs-tab-active:bg-light dark:hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="pills-on-gray-color-item-3" Tab="#pills-on-gray-color-3" Controls="pills-on-gray-color-3">
                  Tab 3
                </SpkButton>
              </nav>
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" Id="pills-with-brand-color-item-1" Tab="#pills-with-brand-color-1" Controls="pills-with-brand-color-1">
                  Tab 1
                </SpkButton>
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="pills-with-brand-color-item-2" Tab="#pills-with-brand-color-2" Controls="pills-with-brand-color-2">
                  Tab 2
                </SpkButton>
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="pills-with-brand-color-item-3" Tab="#pills-with-brand-color-3" Controls="pills-with-brand-color-3">
                  Tab 3
                </SpkButton>
              </nav>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <nav className="sm:flex sm:space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                <SpkButton buttontype="button" customClass="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" Id="fill-and-justify-item-1" Tab="#fill-and-justify-1" Controls="fill-and-justify-1">
                  Tab 1
                </SpkButton>
                <SpkButton buttontype="button" customClass="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="fill-and-justify-item-2" Tab="#fill-and-justify-2" Controls="fill-and-justify-2">
                  Tab 2
                </SpkButton>
                <SpkButton buttontype="button" customClass="w-full hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="fill-and-justify-item-3" Tab="#fill-and-justify-3" Controls="fill-and-justify-3">
                  Tab 3
                </SpkButton>
              </nav>
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white active" Id="equal-width-elements-item-1" Tab="#equal-width-elements-1" Controls="equal-width-elements-1">
                  Tab 1
                </SpkButton>
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="equal-width-elements-item-2" Tab="#equal-width-elements-2" Controls="equal-width-elements-2">
                  Tab 2
                </SpkButton>
                <SpkButton buttontype="button" customClass="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-defaulttextcolor rounded-sm hover:text-primary dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white" Id="equal-width-elements-item-3" Tab="#equal-width-elements-3" Controls="equal-width-elements-3">
                  Tab 3
                </SpkButton>
              </nav>
            ...
            <div className="box-body">
              <div className="border-b border-gray-200 dark:border-white/10">
                <nav className="-mb-0.5 flex justify-center space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active" Id="horizontal-alignment-item-1" Tab="#horizontal-alignment-1" Controls="horizontal-alignment-1">
                    Tab 1
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" Id="horizontal-alignment-item-2" Tab="#horizontal-alignment-2" Controls="horizontal-alignment-2">
                    Tab 2
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" Id="horizontal-alignment-item-3" Tab="#horizontal-alignment-3" Controls="horizontal-alignment-3">
                    Tab 3
                  </SpkButton>
                </nav>
              </div>
            ...
            <div className="box-body">
              <div className="border-b border-gray-200 dark:border-white/10">
                <nav className="-mb-0.5 flex justify-end space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50 active" Id="horizontal-right-alignment-item-1" Tab="#horizontal-right-alignment-1" Controls="horizontal-right-alignment-1">
                    Tab 1
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" Id="horizontal-right-alignment-item-2" Tab="#horizontal-right-alignment-2" Controls="horizontal-right-alignment-2">
                    Tab 2
                  </SpkButton>
                  <SpkButton buttontype="button" customClass="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor hover:text-primary dark:text-[#8c9097] dark:text-white/50" Id="horizontal-right-alignment-item-3" Tab="#horizontal-right-alignment-3" Controls="horizontal-right-alignment-3">
                    Tab 3
                  </SpkButton>
                </nav>
              </div>
