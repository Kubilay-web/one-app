...
interface BlockquotesProps { }

const Blockquotes: FC<BlockquotesProps> = () => {
	return (
		<Fragment>

			{/* <!-- Page Header --> */}
			<Seo title="Blockquotes" />
			<Pageheader Heading="Blockquotes" breadcrumbs={['Ui Elements']} currentpage="Blockquotes" />
			{/* <!-- Page Header Close --> */}

			{/*<!-- Start::row-1 -->*/}
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12">
					<Showcode title="Basic Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote1}>
				...
				<div className="col-span-12">
					<Showcode title="Small Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote2}>
						<blockquote className="relative">
							<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
								width="16" height="16" viewBox="0 0 16 16" fill="none"
								xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
				...
				<div className="col-span-12">
					<Showcode title="Medium Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote3}>
						<blockquote className="relative">
							<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
								width="16" height="16" viewBox="0 0 16 16" fill="none"
								xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
				...
				<div className="col-span-12">
					<Showcode title="Large Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote4}>
						<blockquote className="relative">
							<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
								width="16" height="16" viewBox="0 0 16 16" fill="none"
								xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
				...
				<div className="col-span-12">
					<Showcode title="Center Aligned Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote4}>
				...
				<div className="col-span-12">
					<Showcode title="Right Aligned Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote5}>
				...
				<div className="col-span-12">
					<Showcode title="Naming A Source" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote6}>
						<blockquote className="relative">
							<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
								width="16" height="16" viewBox="0 0 16 16" fill="none"
								xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
				...
				<div className="col-span-12">
					<Showcode title="Blockquote With Avatar" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote7}>
						<blockquote className="relative">
							<svg className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
								width="16" height="16" viewBox="0 0 16 16" fill="none"
								xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
				...
				<div className="col-span-12">
					<Showcode title="Left Bordered Blockquote" customCardBodyClass="!p-[3rem]" reactCode={uiElementsPrism.reactblockquote8}>
						<blockquote
