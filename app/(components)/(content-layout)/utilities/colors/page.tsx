...
const Colors = () => {
    return (
        <Fragment>
            ...
            {/* <!-- Page Header --> */}
            <Seo title="Colors" />
            <Pageheader Heading="Colors" breadcrumbs={['Utilities']} currentpage="Colors" />
            {/* <!-- Page Header Close --> */}
                        ...
                        <div className="box-body">
                            <div className="grid md:grid-cols-8 grid-cols-1 sm:grid-cols-4  items-center">
                                <div className="p-4 col-span-1">
                                    ...
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-primary</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-secondary mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-secondary</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-warning mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-warning</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-info mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-info</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-success mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-success</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-danger mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-danger</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-light mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-light</code></p>
                                </div>
                                <div className="p-4 col-span-1">
                                    <div className="m-2 bg-black mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>bg-dark</code></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="box-body">
                            <div className="grid md:grid-cols-8 grid-cols-1 sm:grid-cols-4  items-center">
                                <div className="p-4 col">
                                    ...
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-primary</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-secondary mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-secondary</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-warning mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-warning</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-info mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-info</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-success mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-success</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-danger mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-danger</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-light mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-light</code></p>
                                </div>
                                <div className="p-4 col">
                                    <div className="m-2 border border-black mx-auto color-container"></div>
                                    <p className="pb-0 mb-0 font-semibold text-center"><code>border-dark</code></p>
                                </div>
                            </div>
                        </div>
                    </div>
