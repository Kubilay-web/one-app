...
const Formswitch: FC<FormswitchProps> = () => {
    return (
        <Fragment>
            ...
            <Pageheader Heading="Form switch" breadcrumbs={['Forms', ' Form Elements']} currentpage="Form switch" />
            {/* <!-- Page Header Close --> */}

            {/* <!-- Start::row-1 --> */}
            <div className="grid grid-cols-12 gap-x-6">
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title=" Default Toggle Switch" reactCode={switch1}>
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Toggle Switch With Tooltip" reactCode={switch2}>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Toggle Switch With Description" reactCode={switch3}>
                ...
                <div className="col-span-12 lg:col-span-6">
                    <Showcode title="Disabled Toggle Switch" reactCode={switch4}>
                        <div className="space-y-4">
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="col-span-12 lg:col-span-6 xl:col-span-6">
                    <Showcode title="Solid Color Variants" reactCode={switch5}>
                    ...
                    <Showcode title="Solid Color With Icons" reactCode={switch6}>
                        <div className="space-x-4 rtl:space-x-reverse">
                            {/* <!-- Switch/Toggle --> */}
                            <div className="relative inline-block">
                ...
                <div className="col-span-12 lg:col-span-6 xl:col-span-6">
                    <Showcode title="Soft Color Variants" reactCode={switch7}>
                        <div className="space-x-4 rtl:space-x-reverse">
                            <div className="relative inline-block">
                    ...
                    <Showcode title="Soft Color With Icons" reactCode={switch8}>
                        <div className="space-x-4 rtl:space-x-reverse">
                            {/* <!-- Switch/Toggle --> */}
                            <div className="relative inline-block">
                ...
                <div className="col-span-12 lg:col-span-6 xl:col-span-6">
                    <Showcode title="Toggle Switch Validation States" reactCode={switch9}>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center">
                                <input type="checkbox" id="hs-invalid-toggle-switch" className="ti-switch shrink-0 checked:bg-none checked:!bg-red-600 checked:!border-red-600 checked:hover:bg-red-600 checked:focus:bg-red-600 focus:border-red-600 focus:ring-red-600 dark:checked:!bg-red-600
                                    checked:before:!bg-red-200 dark:checked:before:bg-red-200" defaultChecked />
                                <label htmlFor="hs-invalid-toggle-switch" className="text-sm text-gray-500 ms-3 dark:text-white/70">Invalid toggle switch</label>
                            </div>
                        </div>
                    </Showcode>
                </div>
                <div className="col-span-12 lg:col-span-6 xl:col-span-6">
                    <Showcode title="Toggle Switch With Sizes" reactCode={switch10}>
                        <div className="space-y-4">
                            <div className="flex items-center">
