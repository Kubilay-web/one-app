...
import { RefundData } from "@/shared/data/apps/ecommers/customer/refundsdata";
            ...
            <div className="main-content landing-main ecommerce-main">
                ...
                <div className="border-b border-defaultborder dark:border-defaultborder/10 py-4 page-breadcrumb">
                    <div className="container">
                        ...
                        <Pageheader Updated={true} breadcrumbs={['Apps', 'Ecommerce', 'Customer']} currentpage="Refund Requests" />
                        {/* Page Header Close */}
                    </div>
                </div>
                {/* End:: Breadcrumb*/}
                                ...
                                <div className="box overflow-hidden">
                                    <div className="box-body !p-0">
                                        <nav className="nav nav-tabs flex !flex-col candidateprofile-nav">
                                            ...
                                            <Link scroll={false} className="nav-link active" href="/ecommerce/customer/refunds">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                    <rect width="256" height="256" fill="none" />
                                ...
                                <div className="box">
                                    ...
                                    <div className="box-body !p-0">
                                        <div className="table-responsive">
                                            <Spktables tableClass="ti-custom-table ti-custom-table-hover ti-custom-table-head w-full" header={[{ title: 'Order Id' }, { title: 'Product', }, { title: 'Ordered Date', }, { title: 'Cost' }, { title: 'Status' }, { title: 'Action' }]}>
                                                {RefundData.map((order, index) => (
                                                    <tr key={index}>
                                                        <td>{order.orderId}</td>
                                                        <td>
                                                            <div className="flex items-center">
                                                                <span className="avatar avatar-sm avatar-square bg-gray-300 dark:bg-light">
                                                                    <Image fill src={order.image} className="w-100 h-100" alt={order.product} />
                                                                </span>
                                                                <div className="ms-2">
                                                                    <p className="font-semibold mb-0 flex items-center">
                                                                        <Link scroll={false} href="#!">{order.product}</Link>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>{order.orderedDate}</td>
                                                        <td className="font-semibold">{order.cost}</td>
                                                        <td>
                                                            <span className={`badge ${order.status === 'Accepted' ? 'bg-success/[0.15] text-success' : order.status === 'Rejected' ? 'bg-danger/[0.15] text-danger' : 'bg-warning/[0.15] text-warning'}`}>
                                                                {order.status}
                                                            </span>
                                                        </td>
                                                        <td>
                                    ...
                                    <div className="box-footer">
                                        <div className="flex items-center flex-wrap overflow-auto">
                                            ...
                                            <div className="ms-auto">
                                                <nav aria-label="Page navigation" className="pagination-style-4 float-end me-1">
