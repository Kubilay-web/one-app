...
import { VariantSimplified } from "@/app/lib/types";
...
const Shop = () => {
  ...
  console.log("products______---", products);

  const [selectedVariant, setSelectedVariant] =
    useState<VariantSimplified | null>(null); // Burada `setSelectedVariant` kullanılır.
                  ...
                  <div className="grid grid-cols-12 items-center gap-y-2">
                    ...
                    <div className="sm:col-span-4 col-span-12 sm:text-end text-start">
                      <div className="btn-group ti-dropdown hs-dropdown">
                        ...
                        >
                          {" "}
                          <i className="ti ti-sort-descending-2 me-0"></i> Sort
                          By{" "}
                          <i className="ri-arrow-down-s-line align-middle ms-0 inline-block"></i>
                        </button>
                  ...
                  <div className="p-4 border-b  dark:border-defaultborder/10">
                    ...
                    <div className="px-2 py-3 pb-0">
                      <div className="form-check !mb-3 !flex items-center">
                        ...
                        <span className="badge bg-light border border-defaultborder dark:border-defaultborder/10 text-default font-medium float-end ms-auto">
                          2,712
                        </span>
                      </div>
                      <div className="form-check !mb-3 !flex items-center">
                      ...
                      <Link
                        scroll={false}
                        className="ecommerce-more-link hs-collapse-toggle"
            ...
            <div className="lg:col-span-8 col-span-12">
              <div className="grid grid-cols-12 gap-x-6">
                {products.map((product: any) => (
                  <div
                    className="xl:col-span-4 md:col-span-6 sm:col-span-6 col-span-12"
                    key={product.id}
                  >
                    <SpkProducts
                      product={product}
                      idx={`/apps/ecommerce/product-details?id=${product.id}`}
                      onclick={() => handleAddToWishlist(product)}
                      card={product}
                      images={product.variantImages} // Burada doğru prop'u aktardığınızdan emin olun
                      variants={product.variants} // Variants prop'unu doğru aktarıyoruz
                      setVariant={setSelectedVariant} // setVariant burada aktarılıyor
                      selectedVariant={selectedVariant} // selectedVariant da aktarıyoruz
                    />
                  </div>
                ))}
                    ...
                    <ul className="ti-pagination justify-end mb-0">
                      <li className="page-item">
                        <Link
                          href="#!"
                          scroll={false}
                          className=" bg-white dark:bg-bodybg page-link disabled"
                        >
                          Previous
                        </Link>
                      </li>
                      <li className="page-item">
                        <Link
                          scroll={false}
                          className="page-link bg-white dark:bg-bodybg"
                          href="#!"
                        >
                          1
                        </Link>
                      ...
                      <li className="page-item" aria-current="page">
                        <Link
                          scroll={false}
                          className="page-link bg-white dark:bg-bodybg active"
                          href="#!"
                        >
                          2
                        </Link>
          ...
          <div className="lg:col-span-6 col-span-10 text-center">
            ...
            <div className="btn-list">
              ...
              >
                <Image
                  fill
                  src="../../../assets/assets/images/media/apps/play-store.png"
                  alt=""
                />
                Google Play
              </Link>
              ...
              >
                <Image
                  fill
                  src="../../../assets/assets/images/media/apps/apple-store.png"
                  alt=""
                  className="invert-1"
                />
                App Store
