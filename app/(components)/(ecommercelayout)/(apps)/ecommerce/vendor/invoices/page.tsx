        ...
        <Fragment>
            ...
            <div className="border-b border-defaultborder dark:border-defaultborder/10 py-4 page-breadcrumb">
                <div className="container">
                    {/* Page Header */}
                    <Seo title={"Invoices"} />
                    <Pageheader Updated={true} breadcrumbs={['Apps', 'Ecommerce', 'Vendor']} currentpage="Invoices" />
                    {/* Page Header Close */}
                </div>
            </div>
            {/* End:: Breadcrumb*/}
                            ...
                            <div className="box">
                                <div className="sm:flex items-start p-4">
                                    ...
                                    <div className="main-profile-info flex-fill">
                                        <div className="font-semibold h6 mb-1"><Link
                            ...
                            <div className="box">
                                ...
                                <div className="box-body !p-0">
                                    <div className="table-responsive">
                                        <Spktables tableClass="ti-custom-table ti-custom-table-head w-full" header={[{ title: 'Invoice ID' }, { title: 'Issued Date', }, { title: 'Amount', }, { title: 'Status' }, { title: 'Due Date' }, { title: 'Action' }]}>
                                            {InvoicesList.map((idx) => (
                                                <tr key={idx.id}>
                                                    <td>
                                                        <Link scroll={false} href="/ecommerce/vendor/invoice-details/" className="font-semibold text-primary">
                                                            {idx.id}
                                                        </Link>
                                                    </td>
                                                    <td>{idx.date} </td>
                                                    ...
                                                    <td>
                                                        <div className="hs-tooltip ti-main-tooltip">
                                                            <Link scroll={false} href="#!" className="ti-btn ti-btn-soft-primary ti-btn-icon ti-btn-sm !m-0 hs-tooltip-toggle !me-1">
                                                        ...
                                                        <div className="hs-tooltip ti-main-tooltip">
                                                            <Link scroll={false} href="#!" className="ti-btn ti-btn-soft-danger ti-btn-icon ti-btn-sm !m-0 hs-tooltip-toggle !me-1">
