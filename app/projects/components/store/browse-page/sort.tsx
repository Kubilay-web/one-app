...
export default function ProductSort() {
  ...
  return (
    <div className="duration-[30ms] relative transition-all">
      <div className="relative inline-block pr-[50px]">
        <div className="flex">
          <div className="!float-right h-9 w-[190px] md:w-[227px]">
            <div className="!float-left h-9 w-[190px] md:w-[227px]">
              <div
                className="group relative z-20 inline-block h-9 w-[190px] outline-0 md:w-[227px]"
              ...
              >
                ...
                <div className="h-9 w-[190px] md:w-[227px]">
                  <div className="relative inline-flex w-full">
                    ...
                    <input
                      ...
                      disabled
                      value={sort}
                      className="h-9 w-full cursor-pointer border bg-transparent bg-none px-3 pr-10 align-bottom text-sm font-bold text-main-primary outline-0 md:pl-[70px]"
                    />
                ...
                <ul
                  className={cn(
                    "absolute max-h-72 w-full transform overflow-auto bg-white py-2 shadow-2xl transition-all duration-300 ease-in-out",
                    {
