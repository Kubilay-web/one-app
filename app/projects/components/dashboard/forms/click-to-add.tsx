    ...
    return (
      ...
      >
        ...
        <svg
          ...
          height="50px"
          viewBox="0 0 24 24"
          className="h-8 w-8 fill-none stroke-blue-400 duration-300 group-hover:fill-blue-primary group-active:fill-blue-700 group-active:stroke-blue-200 group-active:duration-0"
        >
          <path
    ...
    return (
      ...
      >
        ...
        <svg
          ...
          height="50px"
          viewBox="0 0 24 24"
          className="h-8 w-8 fill-none stroke-blue-400 duration-300 group-hover:fill-white group-active:fill-blue-700 group-active:stroke-blue-200 group-active:duration-0"
        >
          <path
            d="M12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22Z"
            strokeWidth="1.5"
