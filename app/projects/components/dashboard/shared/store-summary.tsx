    ...
    <div className="relative py-2">
      <div className="w-full px-1">
        <div className="space-y-3">
          ...
          <h6 className="text-2xl font-semibold leading-9">#{store.id}</h6>
        ...
        <div className="relative mt-4">
          ...
          <Image
            ...
            width={200}
            height={200}
            className="absolute -bottom-11 left-11 h-36 w-36 rounded-full object-cover shadow-lg"
          />
        </div>
        ...
        <div className="mb-6 mt-3 grid grid-cols-1 gap-3 border-gray-100 py-4">
          <div className="grid grid-cols-2">
            <div>
              ...
              <h6 className="text-lg font-semibold leading-9">{store.email}</h6>
            </div>
            <div>
              <p className="mb-3 text-base font-normal leading-7 text-gray-500 transition-all duration-500">
                Store phone number
              </p>
              <h6 className="text-lg font-semibold leading-9">{store.phone}</h6>
            </div>
          </div>
          <div className="grid grid-cols-2">
            <div>
              ...
              <h6 className="text-lg font-semibold leading-9">/{store.url}</h6>
            </div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <tbody>
                ...
                <tr className="s border-b border-opacity-20">
                  <td className="p-3">
