...
const svg1 =  <svg className="sm:flex-shrink-0 me-2 fill-primary" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000">
...
export const iconalerts = [
    {id:1, icon:svg1, color:"primary", dismiss:"iconalert1"},
    {id:2, icon:svg2, color:"success", dismiss:"iconalert2"},
    {id:3, icon:svg3, color:"warning", dismiss:"iconalert3"},
    {id:4, icon:svg4, color:"danger", dismiss:"iconalert4"}
]
...
export const Imagealertslooping: alert7[] = [
	{ id: 1, image: "../../assets/images/faces/3.jpg", color: "primary", class: "" , dismiss:"imagealert1"},
	{ id: 2, image: "../../assets/images/faces/5.jpg", color: "secondary", class: "" , dismiss:"imagealert2"},
	{ id: 3, image: "../../assets/images/faces/8.jpg", color: "warning", class: "" , dismiss:"imagealert3"},
	{ id: 4, image: "../../assets/images/faces/11.jpg", color: "danger", class: "" , dismiss:"imagealert4"},
	{ id: 5, image: "../../assets/images/faces/13.jpg", color: "info", class: "" , dismiss:"imagealert5"},
	{ id: 6, image: "../../assets/images/faces/10.jpg", color: "light", class: "" , dismiss:"imagealert6"},
	{ id: 7, image: "../../assets/images/faces/15.jpg", color: "primary3", class: "border-light" , dismiss:"imagealert7"},
];
...
export const Imagealertswithsize: alert8[] = [
	{ id: 1, image: "../../assets/images/faces/3.jpg", color: "primary", size: "xs", class1: "" , dismiss:"imagesize1"},
	{ id: 2, image: "../../assets/images/faces/5.jpg", color: "secondary", size: "sm", class1: "" , dismiss:"imagesize2"},
	{ id: 3, image: "../../assets/images/faces/8.jpg", color: "warning", size: "", class1: "" , dismiss:"imagesize3"},
	{ id: 4, image: "../../assets/images/faces/11.jpg", color: "danger", size: "md", class1: "" , dismiss:"imagesize4"},
	{ id: 5, image: "../../assets/images/faces/13.jpg", color: "info", size: "lg", class1: "" , dismiss:"imagesize5"},
	{ id: 6, image: "../../assets/images/faces/14.jpg", color: "dark", size: "xl", class1: "text-muted" , dismiss:"imagesize6"},
];
