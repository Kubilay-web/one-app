...
const Spktables: React.FC<Spktables> = ({ children, tableClass, headerClass, Bodytag = true, header, checkboxclass, footerClass, footchildren, headerContent, tBodyClass, checked, showCheckbox = false, Customcheckclass, onChange, tableRowclass }) => {
    return (
        <Fragment>
