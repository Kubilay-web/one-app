...
const Spkimagecapcards: React.FC<Imgcap> = ({ Cardheader = false, Customclass, Title, Imgafterfooter = false, Imgposition, children, CustomTitleclass, Customimgclass, Custombodyclass, Customfooterclass, Imgsrc, CardFooter = false, Footertext }: any) => {
  return (
    <Fragment>
