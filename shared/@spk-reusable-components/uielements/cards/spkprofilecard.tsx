...
const SpkProfilecard: React.FC<profile> = ({ Personalinformation, Imgsrc, Name, Role, Posts, Followers, Following }: any) => {
    return (
        <Fragment>
            <div className="box">
                <div className="box-header">
                    <div className="flex w-full">
                        ...
                        <div className="flex align-center justify-between w-full flex-wrap">
                            <div className="me-4">
                                <p className="text-textmuted dark:text-textmuted/50 mb-0">Posts</p>
                            ...
                            <div className="me-4">
                                <p className="text-textmuted dark:text-textmuted/50 mb-0">Following</p>
                ...
                <div className="box-body">
                    ...
                    <div className="text-textmuted dark:text-textmuted/50 text-[11px] mb-4">{Role}</div>
                    <p className="text-[14px] font-medium mb-1">About:</p>
