                ...
                <div className={`box-header ${Customheaderclass}`}>
                    <ul className={`nav nav-${Navigationclass} box-header-${Navigationclass} ms-1 flex   gap-2 items-center`}>
                        <li className="nav-item">
                            <Link scroll={false} className="nav-link active !py-2 !px-4 !rounded-sm" aria-current="true"
                                href={Navigate}>Active</Link>
                        </li>
                        <li className="nav-item">
                            <Link scroll={false} className="nav-link" href={Navigate}>Link</Link>
                        </li>
                        <li className="nav-item">
                            <Link scroll={false} href={Navigate} className="nav-link disabled">Disabled</Link>
                        </li>
                    </ul>
                </div>
