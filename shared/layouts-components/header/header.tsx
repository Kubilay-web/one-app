...
const Header = ({ local_varaiable, ThemeChanger }: any) => {
  ...
  const initialNotifications = [
    { id: 1, icon: 'message-dots', title: 'Messages', text1: 'John Doe messaged you.', text2: '', text3: '', color: 'primary', class: '' },
    { id: 2, icon: 'shopping-cart', title: 'Orders', text1: 'Order', text2: ' #12345', text3: 'confirmed.', color: 'secondary', class: 'text-warning me-1' },
    { id: 3, icon: 'user-circle', title: 'Profile', text1: 'Complete your profile for offers!', text2: '', text3: '', color: 'success', class: '' },
    { id: 4, icon: 'gift', title: 'Offers', text1: '20% off electronics!', text2: '', text3: '', color: 'orangemain', class: '' },
    { id: 5, icon: 'calendar', title: 'Events', text1: 'Webinar in 1 hour!', text2: '', text3: '', color: 'info', class: '' }
  ];
  ...
  return (
    <Fragment>
          ...
          <div className="main-header-container ">
            <div className="header-content-left">
              ...
              <div className="header-element !items-center">
                {/* <!-- Start::header-link --> */}
                <Link scroll={false} aria-label="Hide Sidebar"
              ...
              {/* <!-- Start::header-element --> */}
              <div ref={containerRef} className="autoComplete_wrapper  header-element header-search md:!block !hidden my-auto relative" id="search-modal">
                {/* <!-- Start::header-link --> */}
                <input type="text" className="header-search-bar form-control" id="header-search"
                  placeholder="Search for Results..." autoComplete="off" autoCapitalize="off" onClick={() => { }} ref={searchRef} defaultValue={InputValue}
                  onChange={(ele) => {
            ...
            <div className="header-content-right">
              ...
              <div
                className="header-element md:px-[0.5rem] px-1  header-country hs-dropdown ti-dropdown  hidden sm:block [--placement:bottom-right] rtl:[--placement:bottom-left]">
                <button id="dropdown-flag" type="button"
                  className="hs-dropdown-toggle ti-dropdown-toggle !p-0 flex-shrink-0  !border-0 !rounded-full !shadow-none">
                  <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon" width="32" height="32"
                    viewBox="0 0 256 256">
                    <rect width="256" height="256" fill="none" />
                    <polygon points="136 184 216 184 176 104 136 184" opacity="0.2" />
                    <path d="M88,127.56A95.78,95.78,0,0,1,56,56h64a95.78,95.78,0,0,1-32,71.56Z" opacity="0.2" />
                    <polyline points="231.97 216 175.97 104 119.97 216" fill="none" stroke="currentColor"
                      strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
                    <line x1="135.97" y1="184" x2="215.97" y2="184" fill="none" stroke="currentColor" strokeLinecap="round"
                      strokeLinejoin="round" strokeWidth="16" />
                    <line x1="87.97" y1="32" x2="87.97" y2="56" fill="none" stroke="currentColor" strokeLinecap="round"
                      strokeLinejoin="round" strokeWidth="16" />
                    <line x1="23.97" y1="56" x2="151.97" y2="56" fill="none" stroke="currentColor" strokeLinecap="round"
                      strokeLinejoin="round" strokeWidth="16" />
                    <path d="M120,56a96,96,0,0,1-96,96" fill="none" stroke="currentColor" strokeLinecap="round"
                      strokeLinejoin="round" strokeWidth="16" />
                    <path d="M61.44,88A96,96,0,0,0,152,152" fill="none" stroke="currentColor" strokeLinecap="round"
                      strokeLinejoin="round" strokeWidth="16" />
                  </svg>
                </button>
                ...
                <ul className="main-header-dropdown ti-dropdown-menu hs-dropdown-menu hidden">
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/us_flag.jpg`} alt="img" />
                      </span>
                      English
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/spain_flag.jpg`} alt="img" />
                      </span>
                      español
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/french_flag.jpg`} alt="img" />
                      </span>
                      français
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/uae_flag.jpg`} alt="img" />
                      </span>
                      عربي
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/germany_flag.jpg`} alt="img" />
                      </span>
                      Deutsch
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/china_flag.jpg`} alt="img" />
                      </span>
                      中国人
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4 !border-b dark:!border-defaultborder/10" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/italy_flag.jpg`} alt="img" />
                      </span>
                      Italiano
                    </Link>
                  </li>
                  <li>
                    <Link scroll={false} className="ti-dropdown-item flex items-center !py-[0.6rem] !px-4" href="#!">
                      <span className="avatar avatar-rounded avatar-xs leading-none me-2 custom-img">
                        <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/flags/russia_flag.jpg`} alt="img" />
                      </span>
                      Русский
                    </Link>
                  </li>
              ...
              <div className="header-element header-theme-mode hidden !items-center sm:block md:!px-[0.5rem] px-1" onClick={() => Toggledark()}>
                <Link scroll={false}  aria-label="anchor"
                  className="hs-dark-mode-active:hidden flex hs-dark-mode group flex-shrink-0 justify-center items-center gap-2  rounded-full font-medium transition-all text-xs dark:bg-bgdark dark:hover:bg-black/20 text-textmuted dark:text-textmuted/50 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                  href="#!">
                  <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon" width="32" height="32" fill="#000000"
                    viewBox="0 0 256 256">
                    <path
              ...
              <div className="header-element cart-dropdown hs-dropdown ti-dropdown md:!block !hidden md:px-[0.5rem] px-1  [--placement:bottom-right] rtl:[--placement:bottom-left]">
                <button id="dropdown-cart" type="button"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon" width="32" height="32" fill="#000000"
                    viewBox="0 0 256 256">
                    <path d="M224,72l-28.52,92.71A16,16,0,0,1,180.18,176H84.07a16,16,0,0,1-15.39-11.6L42.29,72Z"
                      opacity="0.1"></path>
                    <path
                ...
                <div className="main-header-dropdown !p-0 hs-dropdown-menu ti-dropdown-menu !w-[25rem] hidden"
                  aria-labelledby="dropdown-cart">
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      <p className="mb-0 text-[1rem]">Cart Items<span
                        className="badge bg-success/[0.15] text-success ms-1 text-[0.75rem] !rounded-full"
                        id="cart-data">{cartItemCount}</span></p>
                      <Link scroll={false} href="/ecommerce/customer/shop" className="ti-btn ti-btn-soft-secondary ti-btn-sm btn-wave">Continue
                        Shopping <i className="ti ti-arrow-narrow-right ms-1"></i></Link>
                    </div>
                  </div>
                  <div>
                  ...
                  <ul className="list-none mb-0" id="header-cart-items-scroll">
                    {cartItems.map((idx) => (
                      <li className="ti-dropdown-item !border-b !block dark:!border-defaultborder/10" key={idx.id}>
                        <div className="flex items-center cart-dropdown-item gap-4">
                          <div className="leading-none">
                            <span className="avatar avatar-md bg-gray-300 dark:bg-light">
                              <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}${idx.src}`} alt="img" />
                            </span>
                          </div>
                            ...
                            <div className="flex items-center justify-between mb-0">
                              <div className="mb-0 text-[0.875rem] font-medium">
                                ...
                                <div className="text-[0.6875rem] text-textmuted dark:text-textmuted/50">
                                  ...
                                  <span> Color : <span className={`${idx.colorclass} font-semibold`}>{idx.color}</span></span>
                                </div>
                              </div>
                              <div className="text-end">
                                <Link scroll={false} href="#!" className="header-cart-remove dropdown-item-close" onClick={(event) => handleRemove(idx.id, event)}><i className="ri-delete-bin-line opacity-40"></i></Link>
                                <h6 className="font-medium mb-0 mt-1">${idx.newpr}<span
                                  className="line-through text-textmuted dark:text-textmuted/50 font-normal ms-1 text-[0.8125rem] inline-block">${idx.oldpr}</span>
                                </h6>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className={`p-4 empty-header-item   ${cartItemCount === 0 ? 'hidden' : 'block'}`}>
                    <div className="flex items-center justify-between mb-4">
                      <div className="font-medium text-[0.875rem]">Total :</div>
                      <h5 className="mb-0 font-medium">$740</h5>
                    </div>
                    <div className="text-center grid">
                      <Link href="/ecommerce/customer/checkout/" className="ti-btn ti-btn-primary btn-wave waves-effect waves-light">Proceed to checkout</Link>
                    </div>
                  </div>
                  ...
                  <div className={`p-[3rem] empty-item ${cartItemCount === 0 ? 'block' : 'hidden'}`}>
                    <div className="text-center">
                      ...
                      <h6 className="font-medium mb-1 mt-3 text-[1rem] text-defaulttextcolor dark:text-white">Your Cart is Empty
                      </h6>
                      <span
                        className="mb-3 !font-normal text-[0.8125rem] block text-textmuted dark:text-textmuted/50">Add
              ...
              {/* <!--Header Notifictaion --> */}
              <div
                className="header-element  md:px-[0.5rem] px-1 notifications-dropdown header-notification hs-dropdown ti-dropdown !hidden xl:!block [--placement:bottom-right] rtl:[--placement:bottom-left]">
                <button id="dropdown-notification" type="button"
                  className="hs-dropdown-toggle relative ti-dropdown-toggle !p-0 !border-0 flex-shrink-0  !rounded-full !shadow-none align-middle text-xs">
                  <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon animate-bell" width="32" height="32"
                  ...
                  <span className="flex absolute h-[15px] w-[15px] top-[5px] end-[10px]  -me-[0.6rem]">
                    <span
                      className="animate-slow-ping absolute inline-flex -top-[6px] -start-[5px] h-full w-full rounded-full bg-secondary/40 opacity-75"></span>
                    <span
                      className="relative inline-flex justify-center items-center rounded-full  !h-[5px] !w-[5px] bg-secondary"></span>
                  </span>
                </button>
                <div className="main-header-dropdown ti-dropdown-menu hs-dropdown-menu hidden" data-popper-placement="none">
                  <div className="p-4">
                    <div className="flex items-center justify-between">
                      <p className="mb-0 text-[1rem]">Notifications</p>
                      <span className="badge bg-secondary/10 text-secondary !rounded-sm" id="notifiation-data">{`${notifications.length} Unread`}</span>
                    </div>
                  </div>
                  <div className="dropdown-divider"></div>
                  <ul className="ti-list-unstyled mb-0" id="header-notification-scroll">
                    {notifications.map((idx, index) => (
                      <li className="ti-dropdown-item !block !border-b dark:!border-defaultborder/10" key={index}>
                        <div className="flex items-center">
                          <div className="pe-2 leading-none">
                            <span className={`avatar avatar-md avatar-rounded bg-${idx.color} text-white`}>
                              <i className={`ti ti-${idx.icon} text-[1.25rem]`}></i>
                            </span>
                          </div>
                          <div className="flex-grow flex items-center justify-between">
                            <div>
                              <p className="mb-0 font-medium"><Link scroll={false} href="#!">{idx.title}</Link></p>
                              <div className="text-textmuted dark:text-textmuted/50 font-normal text-[0.75rem] header-notification-text truncate">
                                {idx.text1}<span className={idx.class}>{idx.text2}</span>{idx.text3}</div>
                            </div>
                            <div>
                              <Link scroll={false} href="#!" className="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1" onClick={() => handleRemove1(idx.id)}><i
                                className="ri-close-circle-line opacity-40 text-[1.25rem]"></i></Link>
                            </div>
                          </div>
                        </div>
                      </li>
                  ...
                  <div className={`p-4 empty-header-item1  ${notifications.length === 0 ? 'hidden' : 'block'}`}>
                    <div className="grid">
              ...
              <li className="header-element header-fullscreen" >
                {/* <!-- Start::header-link --> */}
                <Link scroll={false} onClick={toggleFullscreen}
                  href="#!"
                  className="header-link"
                  aria-label="anchor"
                >
                  {isFullscreen ? (
                    <svg xmlns="http://www.w3.org/2000/svg" className="full-screen-close header-link-icon block" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="full-screen-open header-link-icon block" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
                      <path d="M208,48V88L168,48ZM48,208H88L48,168Zm160,0V168l-40,40ZM48,88,88,48H48Z" opacity="0.1">
                      </path>
              ...
              {/* <!-- Header Profile --> */}
              <div
                className="header-element md:!px-[0.5rem] px-2 ti-dropdown hs-dropdown !items-center [--placement:bottom-right] rtl:[--placement:bottom-left]">

                <button id="dropdown-profile" type="button"
                  className="hs-dropdown-toggle ti-dropdown-toggle !gap-2 !p-0 flex-shrink-0 sm:me-2 me-0 !rounded-full !shadow-none text-xs align-middle !border-0 !shadow-transparent ">
                  <Image fill src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/faces/14.jpg`} alt="Image Description" className="avatar avatar-sm avatar-rounded inline-block" />
                </button>
                ...
                <ul className="main-header-dropdown ti-dropdown-menu hs-dropdown-menu !w-[11rem] hidden pt-0 overflow-hidden header-profile-dropdown">
                  <li><Link scroll={false} className="ti-dropdown-item !py-[0.6rem] !px-4 !border-b flex items-center  dark:!border-defaultborder/10" href="/pages/profile"><i
                    className="ti ti-user me-2 text-[1.125rem] text-primary"></i>Profile</Link></li>
                  <li><Link scroll={false} className="ti-dropdown-item !py-[0.6rem] !px-4 !border-b flex items-center  dark:!border-defaultborder/10" href="/pages/email/mail-app"><i
                    className="ti ti-mail me-2 text-[1.125rem] text-secondary"></i>Inbox</Link></li>
                  <li><Link scroll={false} className="ti-dropdown-item !py-[0.6rem] !px-4 !border-b flex items-center  dark:!border-defaultborder/10" href="/pages/todolist"><i
                    className="ti ti-checklist me-2 text-[1.125rem] text-success"></i>Task Manager</Link></li>
                  <li><Link scroll={false} className="ti-dropdown-item !py-[0.6rem] !px-4 !border-b flex items-center  dark:!border-defaultborder/10" href="/pages/email/mail-settings"><i
              ...
              <div className="header-element md:px-[0.48rem]">
                <button aria-label="button" type="button"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="header-link-icon animate-spin-slow" width="32" height="32"
                    fill="#000000" viewBox="0 0 256 256">
                    <path
      ...
      <div id="search-modal" className="hs-overlay ti-modal hidden mt-[1.75rem]" tabIndex={-1}>
          ...
          <div className="ti-modal-content !border !border-defaultborder dark:!border-defaultborder/10 !rounded-[0.5rem]">
            <div className="ti-modal-body">
              <div className="input-group">
                <input type="text" className="form-control !border-s border-e-0" placeholder="Search Anything ..." aria-label="Search Anything ..." aria-describedby="button-addon2" />
                <button className="ti-btn ti-btn-primary !m-0" type="button" id="button-addon2"><i className="bi bi-search"></i></button>
              </div>
            </div>
