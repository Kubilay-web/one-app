...
const Elementsicon = <svg xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" width="32" height="32" viewBox="0 0 256 256"><path d="M216,96v96a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V96Z" opacity="0.2"></path><path d="M224,48H32A16,16,0,0,0,16,64V88a16,16,0,0,0,16,16v88a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V104a16,16,0,0,0,16-16V64A16,16,0,0,0,224,48ZM208,192H48V104H208ZM224,88H32V64H224V88ZM96,136a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H104A8,8,0,0,1,96,136Z"></path></svg>
const Advanceuiicon = <svg xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" width="32" height="32" viewBox="0 0 256 256"><path d="M58.89,154.89l42.22,42.22-50.63,18.4a7.79,7.79,0,0,1-10-10Zm138.82-4.72L105.83,58.29A7.79,7.79,0,0,0,93,61.14l-14.9,41,75.82,75.82,41-14.9A7.79,7.79,0,0,0,197.71,150.17Z" opacity="0.2"></path><path d="M111.49,52.63a15.8,15.8,0,0,0-26,5.77L33,202.78A15.83,15.83,0,0,0,47.76,224a16,16,0,0,0,5.46-1l144.37-52.5a15.8,15.8,0,0,0,5.78-26Zm-8.33,135.21-35-35,13.16-36.21,58.05,58.05Zm-55,20,14-38.41,24.45,24.45ZM156,168.64,87.36,100l13-35.87,91.43,91.43ZM160,72a37.8,37.8,0,0,1,3.84-15.58C169.14,45.83,179.14,40,192,40c6.7,0,11-2.29,13.65-7.21A22,22,0,0,0,208,23.94,8,8,0,0,1,224,24c0,12.86-8.52,32-32,32-6.7,0-11,2.29-13.65,7.21A22,22,0,0,0,176,72.06,8,8,0,0,1,160,72ZM136,40V16a8,8,0,0,1,16,0V40a8,8,0,0,1-16,0Zm101.66,82.34a8,8,0,1,1-11.32,11.31l-16-16a8,8,0,0,1,11.32-11.32Zm4.87-42.75-24,8a8,8,0,0,1-5.06-15.18l24-8a8,8,0,0,1,5.06,15.18Z"></path></svg>
const Utilitiesicon = <svg xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" width="32" height="32" viewBox="0 0 256 256"><path d="M176,96a48,48,0,1,1-48-48A48,48,0,0,1,176,96Z" opacity="0.2"></path><path d="M216,96A88,88,0,1,0,72,163.83V240a8,8,0,0,0,11.58,7.16L128,225l44.43,22.21A8.07,8.07,0,0,0,176,248a8,8,0,0,0,8-8V163.83A87.85,87.85,0,0,0,216,96ZM56,96a72,72,0,1,1,72,72A72.08,72.08,0,0,1,56,96ZM168,227.06l-36.43-18.21a8,8,0,0,0-7.16,0L88,227.06V174.37a87.89,87.89,0,0,0,80,0ZM128,152A56,56,0,1,0,72,96,56.06,56.06,0,0,0,128,152Zm0-96A40,40,0,1,1,88,96,40,40,0,0,1,128,56Z"></path></svg>
...
const Tableicon = <svg xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" width="32" height="32" viewBox="0 0 256 256"><path d="M88,104v96H32V104Z" opacity="0.2"></path><path d="M224,48H32a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A8,8,0,0,0,224,48ZM40,112H80v32H40Zm56,0H216v32H96ZM216,64V96H40V64ZM40,160H80v32H40Zm176,32H96V160H216v32Z"></path></svg>
...
export const MENUITEMS: any = [
  ...
  },
  {
    title: "Dashboards", icon: Dashboardicon, type: "sub", active: false, children: [
      ...
      { path: "/dashboards/medical", type: "link", active: false, selected: false, title: "Medical" },
      { path: "/dashboards/pos-system", type: "link", active: false, selected: false, title: "POS System" },
      { path: "/dashboards/podcast", type: "link", active: false, selected: false, title: "Podcast" },
      { path: "/dashboards/school", type: "link", active: false, selected: false, title: "School" },
      { path: "/dashboards/social-media", type: "link", active: false, selected: false, title: "Social Media" },
    ]
  },
  {
    menutitle: "Web Apps",
  ...
  {
    title: "Apps", icon: Appsicon,badgetxt: badge1, type: "sub", active: false, selected: false, children: [
      {
        title: "Ecommerce", type: "sub", active: false, children: [
          {
            title: "Admin", type: "sub", active: false, children: [
              { path: "/apps/ecommerce/admin/add-customer", type: "link", active: false, selected: false, title: "Add Customer" },
              { path: "/apps/ecommerce/admin/add-product", type: "link", active: false, selected: false, title: "Add Product" },
              { path: "/apps/ecommerce/admin/add-vendor", type: "link", active: false, selected: false, title: "Add Vendor" },
              { path: "/apps/ecommerce/admin/blog", type: "link", active: false, selected: false, title: "Blog" },
              { path: "/apps/ecommerce/admin/customer-details", type: "link", active: false, selected: false, title: "Customer Details" },
              { path: "/apps/ecommerce/admin/customers-list", type: "link", active: false, selected: false, title: "Customers List" },
              { path: "/apps/ecommerce/admin/faqs", type: "link", active: false, selected: false, title: "Faq's" },
              { path: "/apps/ecommerce/admin/news-letter", type: "link", active: false, selected: false, title: "News Letter" },
              { path: "/apps/ecommerce/admin/orders", type: "link", active: false, selected: false, title: "Orders" },
              { path: "/apps/ecommerce/admin/order-details", type: "link", active: false, selected: false, title: "Order Details" },
              { path: "/apps/ecommerce/admin/payment-gateways", type: "link", active: false, selected: false, title: "Payment Gateways" },
              { path: "/apps/ecommerce/admin/products", type: "link", active: false, selected: false, title: "Products" },
              { path: "/apps/ecommerce/admin/refund-requests", type: "link", active: false, selected: false, title: "Refund Requests" },
              { path: "/apps/ecommerce/admin/reports", type: "link", active: false, selected: false, title: "Reports" },
              { path: "/apps/ecommerce/admin/testimonials", type: "link", active: false, selected: false, title: "Testimonials" },
              { path: "/apps/ecommerce/admin/vendor-details", type: "link", active: false, selected: false, title: "Vendor Details" },
              { path: "/apps/ecommerce/admin/vendors-list", type: "link", active: false, selected: false, title: "Vendors List" },
              { path: "/apps/ecommerce/admin/app-settings", type: "link", active: false, selected: false, title: "App Settings" },
            ]
          },
          {
            title: "Customer", type: "sub", active: false, children: [
              { path: "/ecommerce/customer/customer", type: "link", active: false, selected: false, title: "Customer" },
              { path: "/ecommerce/customer/address", type: "link", active: false, selected: false, title: "Address" },
              { path: "/ecommerce/customer/landing-page", type: "link", active: false, selected: false, title: "landing Page" },
              { path: "/ecommerce/customer/shop", type: "link", active: false, selected: false, title: "Shop" },
              { path: "/ecommerce/customer/product-details", type: "link", active: false, selected: false, title: "Product Details" },
              { path: "/ecommerce/customer/cart", type: "link", active: false, selected: false, title: "Cart" },
              { path: "/ecommerce/customer/checkout", type: "link", active: false, selected: false, title: "Checkout" },
              { path: "/ecommerce/customer/compare-products", type: "link", active: false, selected: false, title: "Compare Products" },
              { path: "/ecommerce/customer/coupons", type: "link", active: false, selected: false, title: "Coupons" },
              { path: "/ecommerce/customer/order-tracking", type: "link", active: false, selected: false, title: "Order Tracking" },
              { path: "/ecommerce/customer/refunds", type: "link", active: false, selected: false, title: "Refunds" },
              { path: "/ecommerce/customer/settings", type: "link", active: false, selected: false, title: "Settings" },
              { path: "/ecommerce/customer/wishlist", type: "link", active: false, selected: false, title: "Wishlist" },
            ]
          },
          {
            title: "Vendor", type: "sub", active: false, children: [
              { path: "/ecommerce/vendor/vendor", type: "link", active: false, selected: false, title: "Vendor" },
              { path: "/ecommerce/vendor/add-product", type: "link", active: false, selected: false, title: "Add Product" },
              { path: "/ecommerce/vendor/invoice-details", type: "link", active: false, selected: false, title: "Invoice Details" },
              { path: "/ecommerce/vendor/invoices", type: "link", active: false, selected: false, title: "Invoices" },
              { path: "/ecommerce/vendor/orders", type: "link", active: false, selected: false, title: "Orders" },
              { path: "/ecommerce/vendor/packages", type: "link", active: false, selected: false, title: "Packages" },
              { path: "/ecommerce/vendor/profile", type: "link", active: false, selected: false, title: "Profile" },
              { path: "/ecommerce/vendor/refund-requests", type: "link", active: false, selected: false, title: "Refund Requests" },
              { path: "/ecommerce/vendor/settings", type: "link", active: false, selected: false, title: "Settings" },
            ]
          }
      ...
      {
        title: "Classifieds", type: "sub", active: false, children: [
          { path: "/apps/classifieds/admin", type: "link", active: false, selected: false, title: "Admin" },
          { path: "/classifieds/classified-details", type: "link", active: false, selected: false, title: "Classified Details" },
          { path: "/classifieds/landing", type: "link", active: false, selected: false, title: "Landing" },
          { path: "/classifieds/search", type: "link", active: false, selected: false, title: "Search" },
          { path: "/apps/classifieds/user-profile", type: "link", active: false, selected: false, title: "User Profile" },
        ]
      },
      {
        title: "Domain", type: "sub", active: false, children: [
          { path: "/apps/domain/admin", type: "link", active: false, selected: false, title: "Admin" },
          { path: "/domain/single-landing", type: "link", active: false, selected: false, title: "Single Landing" },
          { path: "/domain/domain-details", type: "link", active: false, selected: false, title: "Domain Details" },
          { path: "/domain/landing", type: "link", active: false, selected: false, title: "Landing" },
        ]
      },
      {
        title: "Market Place", type: "sub", active: false, children: [
          { path: "/apps/market-place/admin", type: "link", active: false, selected: false, title: "Admin" },
          { path: "/market-place/details", type: "link", active: false, selected: false, title: "Details" },
          { path: "/market-place/landing", type: "link", active: false, selected: false, title: "Landing" },
          { path: "/market-place/search", type: "link", active: false, selected: false, title: "Search" },
          { path: "/market-place/user", type: "link", active: false, selected: false, title: "User" },
          { path: "/market-place/user-profile", type: "link", active: false, selected: false, title: "User Profile" },
          { path: "/market-place/vendor", type: "link", active: false, selected: false, title: "Vendor" },
        ]
      },
      {
        title: "Real Estate", type: "sub", active: false, children: [
          { path: "/apps/real-estate/admin", type: "link", active: false, selected: false, title: "Admin" },
          { path: "/real-estate/details", type: "link", active: false, selected: false, title: "Details" },
          { path: "/real-estate/landing", type: "link", active: false, selected: false, title: "Landing" },
          { path: "/real-estate/search", type: "link", active: false, selected: false, title: "Search" },
          { path: "/real-estate/user", type: "link", active: false, selected: false, title: "User" },
          { path: "/real-estate/user-profile", type: "link", active: false, selected: false, title: "User Profile" },
          { path: "/real-estate/vendor", type: "link", active: false, selected: false, title: "Vendor" },
        ]
      },
      ...
      {
        title: "Projects", type: "sub", active: false, children: [
          { path: "/apps/projects/projects-list", type: "link", active: false, selected: false, title: "Projects List" },
      ...
      {
        title: "Task", type: "sub", active: false, children: [
          { path: "/apps/task/kanban-board", type: "link", active: false, selected: false, title: "Kanban Board" },
          { path: "/apps/task/list-view", type: "link", active: false, selected: false, title: "List View" },
          { path: "/apps/task/task-details", type: "link", active: false, selected: false, title: "Task Details" },
        ]
      },
      {
        title: "Jobs", type: "sub", active: false, children: [
      ...
      {
        title: "CRM", type: "sub", active: false, children: [
      ...
      {
        title: "Crypto", type: "sub", active: false, children: [
          { path: "/apps/crypto/transactions", type: "link", active: false, selected: false, title: "Transactions" },
          { path: "/apps/crypto/currency-exchange", type: "link", active: false, selected: false, title: "Currency Exchange" },
          { path: "/apps/crypto/buy-sell", type: "link", active: false, selected: false, title: "Buy & Sell" },
          { path: "/apps/crypto/marketcap", type: "link", active: false, selected: false, title: "Marketcap" },
  ...
  // },
  {
    icon: Pagesicon, title: "Pages", type: "sub", active: false, children: [
     ...
     { path: "/social", type: "link", active: false, selected: false, title: "Social" },
      ...
      { path: "/news", type: "link", active: false, selected: false, title: "News" },
      ...
      { path: "/pages/file-manager", type: "link", active: false, selected: false, title: "File Manager" },
      {
      ...
      { path: "/pages/profile-setting", type: "link", active: false, selected: false, title: "Profile Settings" },
      { path: "/pages/reviews", type: "link", active: false, selected: false, title: "Reviews" },
      { path: "/pages/search", type: "link", active: false, selected: false, title: "Search" },
