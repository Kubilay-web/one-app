				...
				<div className="container">
					<div className="grid grid-cols-12 gap-x-6 items-center">
						<div className="lg:col-span-6 col-span-12 lg:text-start text-center">
							<span className="text-white opacity-70 text-[0.875rem]"> © Copyright 2025<span id="year"></span> <Link scroll={false}
								href="#!" className="text-primary text-[0.875rem] font-semibold">Mamix</Link>.
							</span>
						</div>
